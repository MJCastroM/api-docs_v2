...
@Component({
  selector: 'app-ConvertirTasaMensualEfectivaaLineal',
  templateUrl: './DocTemplate.component.html',
  styleUrls: ['./DocTemplate.component.scss'],
  animations: [ fadeInOut ],
  host: { '[@fadeInOut]': '' }
})
export class ConvertirTasaMensualEfectivaaLinealComponent {
  pageTitle = 'Convertir Tasa Mensual Efectiva a Lineal';
  description = `Metodo para convertir una tasa efectiva mensual a tasa lineal mensual.`;
  ...
  inputData  = [{ Nombre: 'tipoTasaOrigen', Tipo: 'Short', Comentarios: 'Tipo de tasa origen [Hidden: Valor fijo '3' para este metodo].' }, { Nombre: 'tasaOrigen', Tipo: 'Double', Comentarios: 'Tasa a convertir.' }, { Nombre: 'tipoAnio', Tipo: 'Short', Comentarios: 'Tipo de ano [1 - Comercial / 2 - Calendario].' }, { Nombre: 'plazo', Tipo: 'Int', Comentarios: 'Plazo.' }, { Nombre: 'tipoTasaDestino', Tipo: 'Short', Comentarios: 'Tipo de tasa destino [Hidden: Valor fijo '4' para este metodo].' }];
