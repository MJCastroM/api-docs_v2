...
export class ObtenerPrecioaFechaComponent {
  // Cabecera e info-card
  pageTitle = 'Obtener Precio a Fecha';
  description = `Metodo para obtener la cotizacion en moneda nacional de una especie en la fecha recibida.`;
