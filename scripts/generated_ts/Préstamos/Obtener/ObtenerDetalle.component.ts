...
export class ObtenerDetalleComponent {
  // Cabecera e info-card
  pageTitle = 'Obtener Detalle';
  description = `Metodo para obtener los datos de un prestamo.`;
  pubName    = 'BTPrestamos.ObtenerDetalle';
  programa   = 'RBTPG012';
  scope      = 'Global';
