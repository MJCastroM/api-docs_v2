...
export class ObtenerCronogramaenEspecieComponent {
  pageTitle = 'Obtener Cronograma en Especie';
  description = `Metodo para obtener el cronograma de un prestamo expresado en especie.`;
  ...
  inputData  = [{ Nombre: 'operacionUId', Tipo: 'Long', Comentarios: 'Identificador unico de operacion.' }, { Nombre: 'expresadoEn', Tipo: 'String', Comentarios: '[Hidden: Valor fijo 'E' para este metodo].' }];
