...
export class ObtenerProductosRefinanciacionComponent {
  pageTitle = 'Obtener Productos Refinanciacion';
  description = ``;
  pubName    = '';
  programa   = '';
  scope      = '';
