...
export class PagarCuotaComponent {
  ...
  description = `Metodo para realizar el pago de cuota de un prestamo.`;
  ...
  inputCols  = ['operacionUId', 'clienteUId', 'importe', 'operacionUId_cobro', 'referencia'];
  ...
  errors     = [{ Codigo: '30001', Descripcion: 'No se recibio el identificador de operacion de prestamo.' }, { Codigo: '30002', Descripcion: 'No se recibio el identificador de operacion de cobro.' }, { Codigo: '30003', Descripcion: 'Debe ingresar importe.' }, { Codigo: '30004', Descripcion: 'No se recupero la operacion para el Identificador: [Numero de Identificador].' }, { Codigo: '30005', Descripcion: 'No se recupero la operacion para el Identificador: [Numero de Identificador].' }, { Codigo: '30006', Descripcion: 'No se recibio el identificador de cliente.' }, { Codigo: '30007', Descripcion: 'No se recupero la operacion para el Identificador de Cliente: [Numero de Identificador].' }, { Codigo: '30008', Descripcion: 'El prestamo no pertenece al cliente.' }, { Codigo: '30009', Descripcion: 'La operacion de cobro no pertenece al cliente.' }, { Codigo: '30100', Descripcion: 'Error en la contabilizacion.' }, { Codigo: '40001', Descripcion: 'La Cuenta indicada es incorrecta.' }];
