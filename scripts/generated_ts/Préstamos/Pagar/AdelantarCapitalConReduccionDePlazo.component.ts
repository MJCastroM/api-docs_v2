...
export class AdelantarCapitalConReduccionDePlazoComponent {
  pageTitle = 'Adelantar Capital Con Reduccion De Plazo';
  description = `Metodo para realizar el pago de cuota de un prestamo con reduccion de plazo.`;
