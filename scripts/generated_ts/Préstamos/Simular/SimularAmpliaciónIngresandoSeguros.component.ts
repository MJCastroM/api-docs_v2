...
@Component({
  selector: 'app-SimularAmpliacinIngresandoSeguros',
  templateUrl: './DocTemplate.component.html',
  styleUrls: ['./DocTemplate.component.scss'],
  animations: [ fadeInOut ],
  host: { '[@fadeInOut]': '' }
})
export class SimularAmpliacionIngresandoSegurosComponent {
  pageTitle = 'Simular Ampliacion Ingresando Seguros';
  description = `Metodo para simular una ampliacion de uno o mas prestamos ingresando los seguros a aplicar.`;
  ...
  backendText       = `Tiempo de validez de la simulacion de una ampliacion o refinanciacion: 

Por defecto es 1440 minutos (24 horas). Este valor se puede modificar ingresando los minutos en el valor especifico 1 de la guia especial 20100 para los correlativos 1, 2 y 3 igual cero. 

:::`;
  backendConfig     = [];

  inputData  = [{ Nombre: 'sdtAmpliacion', Tipo: '[sBTAmpliacionAlta](#sbtampliacionalta)', Comentarios: 'Datos de simulacion.' }, { Nombre: 'sinSeguros', Tipo: 'String', Comentarios: 'Accion a tomar cuando la lista de seguros a aplicar es vacia (S: Simula sin tener en cuenta ningun seguro, N: Simula con los seguros preseteados).' }, { Nombre: 'sdtSeguros', Tipo: '[sBTSegurosSimulacion](#sbtsegurossimulacion)', Comentarios: 'Listado de codigos de seguros a aplicar.' }];
  outputData = [{ Nombre: 'ampliacionId', Tipo: 'Long', Comentarios: 'Identificador de ampliacion.' }, { Nombre: 'sdtSimulacion', Tipo: '[sBTSimulacionPrestamo](#sbtsimulacionprestamo)', Comentarios: 'Datos del prestamo simulado.' }, { Nombre: 'deudaTotalCancelacion', Tipo: 'Double', Comentarios: 'Monto de cancelacion total de los prestamos a consolidar.' }];
