...
export class ResimularRefinanciacionComponent {
  // Cabecera e info-card
  pageTitle = 'Resimular Refinanciacion';
  description = `Metodo para resimular la refinanciacion de un prestamo.`;
  ...
  inputCols  = ['simulacionUId', 'sdtSimulacionUpdate', 'accion'];
  inputData  = [{ Nombre: 'simulacionUId', Tipo: 'Long', Comentarios: 'Identificador unico de la simulacion.' }, { Nombre: 'sdtSimulacionUpdate', Tipo: '[sBTSimulacionUpdate](#sbtsimulacionupdate)', Comentarios: 'Datos de la resimulacion.' }, { Nombre: 'accion', Tipo: 'String', Comentarios: '[Hidden: Valor fijo "REFI" para este metodo].' }];
  ...
  errors     = [{ Codigo: '30001', Descripcion: 'No se recibio el identificador de Refinanciacion.' }, { Codigo: '30002', Descripcion: 'No se recibio el identificador de cliente.' }, { Codigo: '30003', Descripcion: 'No se recupero la cuenta para el Identificador: [Numero de Identificador].' }, { Codigo: '30004', Descripcion: 'El identificador de Refinanciacion no es valido.' }, { Codigo: '30005', Descripcion: 'El prestamo no pertenece al cliente.' }, { Codigo: '30006', Descripcion: 'No se recupero la operacionUId de la operacion a refinanciar.' }, { Codigo: '30007', Descripcion: 'No se recupero la operacion a cancelar para el identificador [Numero de Identificador].' }];
