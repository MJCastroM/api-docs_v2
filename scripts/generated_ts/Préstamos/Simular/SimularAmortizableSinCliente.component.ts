...
export class SimularAmortizableSinClienteComponent {
  pageTitle = 'Simular Amortizable Sin Cliente';
  description = `Metodo para simular el alta de un prestamo amortizable sin cliente.`;
