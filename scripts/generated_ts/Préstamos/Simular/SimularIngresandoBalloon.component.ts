...
@Component({
  selector: 'app-SimularIngresandoBalloon',
  templateUrl: './DocTemplate.component.html',
  styleUrls: ['./DocTemplate.component.scss'],
  animations: [ fadeInOut ],
  host: { '[@fadeInOut]': '' }
})
export class SimularIngresandoBalloonComponent {
  pageTitle = 'Simular Ingresando Balloon';
  description = `Metodo para simular un prestamo ingresando el balloon.`;
  ...
  inputData  = [{ Nombre: 'sdtPrestamoAlta', Tipo: '[sBTPrestamoAltaConDespeje](#sbtprestamoaltacondespeje)', Comentarios: 'Datos del prestamo a dar de alta.' }, { Nombre: 'modoDespeje', Tipo: 'Short', Comentarios: '[Hidden: Valor fijo '6' para este metodo].' }];
