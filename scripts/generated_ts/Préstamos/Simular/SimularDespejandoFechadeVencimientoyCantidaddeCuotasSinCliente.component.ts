...
export class SimularDespejandoFechadeVencimientoyCantidaddeCuotasSinClienteComponent {
  pageTitle = 'Simular Despejando Fecha de Vencimiento y Cantidad de Cuotas Sin Cliente';
  description = `Metodo para simular un prestamo sin cliente despejando fecha de vencimiento y cantidad de cuotas.`;
  ...
  inputData  = [{ Nombre: 'sdtPrestamoAlta', Tipo: '[sBTDatosDespejeSinCliente](#sbtdatosdespejesincliente)', Comentarios: 'Datos del prestamo a dar de alta.' }, { Nombre: 'modoDespeje', Tipo: 'Short', Comentarios: '[Hidden: Valor fijo '4' para este metodo].' }];
