...
export class SimularDespejandoCapitalyCantidaddeCuotasComponent {
  pageTitle = 'Simular Despejando Capital y Cantidad de Cuotas';
  description = `Metodo para simular un prestamo despejando capital y cantidad de cuotas.`;
  ...
  inputData  = [{ Nombre: 'sdtPrestamoAlta', Tipo: '[sBTPrestamoAltaConDespeje](#sbtprestamoaltacondespeje)', Comentarios: 'Datos del prestamo a dar de alta.' }, { Nombre: 'modoDespeje', Tipo: 'Short', Comentarios: '[Hidden: Valor fijo '5' para este metodo].' }];
