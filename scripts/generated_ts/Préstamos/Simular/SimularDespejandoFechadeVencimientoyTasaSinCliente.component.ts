...
export class SimularDespejandoFechadeVencimientoyTasaSinClienteComponent {
  pageTitle = 'Simular Despejando Fecha de Vencimiento y Tasa Sin Cliente';
  description = `Metodo para simular un prestamo sin cliente despejando fecha de vencimiento y tasa.`;
  ...
  inputData  = [{ Nombre: 'sdtPrestamoAlta', Tipo: '[sBTDatosDespejeSinCliente](#sbtdatosdespejesincliente)', Comentarios: 'Datos del prestamo a dar de alta.' }, { Nombre: 'modoDespeje', Tipo: 'Short', Comentarios: '[Hidden: Valor fijo '7' para este metodo].' }];
