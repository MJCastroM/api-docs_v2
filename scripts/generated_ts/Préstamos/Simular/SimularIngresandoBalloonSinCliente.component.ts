...
export class SimularIngresandoBalloonSinClienteComponent {
  pageTitle = 'Simular Ingresando Balloon Sin Cliente';
  description = `Metodo para simular un prestamo sin cliente ingresando el balloon.`;
  ...
  inputData  = [{ Nombre: 'sdtPrestamoAlta', Tipo: '[sBTDatosDespejeSinCliente](#sbtdatosdespejesincliente)', Comentarios: 'Datos del prestamo a dar de alta.' }, { Nombre: 'modoDespeje', Tipo: 'Short', Comentarios: '[Hidden: Valor fijo '6' para este metodo].' }];
