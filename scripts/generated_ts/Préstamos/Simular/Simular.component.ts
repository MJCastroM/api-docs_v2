...
export class SimularComponent {
  ...
  backendText       = `Si la opcion general de procesos 3281 se encuentra activada, el servicio considera la sucursal del usuario de conexion, en caso contrario, simula con la sucursal de la cuenta cliente. 
