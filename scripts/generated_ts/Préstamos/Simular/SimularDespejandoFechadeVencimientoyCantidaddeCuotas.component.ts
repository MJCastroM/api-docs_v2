...
export class SimularDespejandoFechadeVencimientoyCantidaddeCuotasComponent {
  pageTitle = 'Simular Despejando Fecha de Vencimiento y Cantidad de Cuotas';
  description = `Metodo para simular un prestamo despejando fecha de vencimiento y cantidad de cuotas.`;
  ...
  inputData  = [{ Nombre: 'sdtPrestamoAlta', Tipo: '[sBTPrestamoAlta](#sbtprestamoaltacondespeje)', Comentarios: 'Datos del prestamo a dar de alta.' }, { Nombre: 'modoDespeje', Tipo: 'Short', Comentarios: '[Hidden: Valor fijo '4' para este metodo].' }];
