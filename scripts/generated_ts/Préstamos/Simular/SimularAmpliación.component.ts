...
@Component({
  selector: 'app-SimularAmpliacin',
  templateUrl: './DocTemplate.component.html',
  styleUrls: ['./DocTemplate.component.scss'],
  animations: [ fadeInOut ],
  host: { '[@fadeInOut]': '' }
})
export class SimularAmpliacionComponent {
  pageTitle = 'Simular Ampliacion';
  description = `Metodo para simular una ampliacion de uno o mas prestamos.`;
...
:::`;
  ...
  inputData  = [{ Nombre: 'sdtAmpliacion', Tipo: '[sBTAmpliacionAlta](#sbtampliacionalta)', Comentarios: 'Datos de simulacion.' }];
