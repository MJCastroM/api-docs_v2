...
@Component({
  selector: 'app-ResimularAmortizable',
  templateUrl: './DocTemplate.component.html',
  styleUrls: ['./DocTemplate.component.scss'],
  animations: [ fadeInOut ],
  host: { '[@fadeInOut]': '' }
})
export class ResimularAmortizableComponent {
  // Cabecera e info-card
  pageTitle = 'Resimular Amortizable';
  description = `Metodo para resimular un prestamo amortizable.`;
  ...
  inputCols  = ['operacionUId', 'sdtSimulacionUpdate', 'paramAux'];
  inputData  = [{ Nombre: 'operacionUId', Tipo: 'Long', Comentarios: 'Identificador unico de la operacion.' }, { Nombre: 'sdtSimulacionUpdate', Tipo: '[sBTSimulacionUpdate](#sbtsimulacionupdate)', Comentarios: 'Datos de la resimulacion.' }, { Nombre: 'paramAux', Tipo: 'String', Comentarios: '[Hidden: Valor fijo "" para este metodo].' }];
  ...
  errors     = [{ Codigo: '30001', Descripcion: 'No se recibio identificador de operacion.' }, { Codigo: '30002', Descripcion: 'No se recibio el identificador de cliente.' }, { Codigo: '30003', Descripcion: 'No se recupero la cuenta para el Identificador: [Numero de Identificador].' }, { Codigo: '30004', Descripcion: 'No se recupero la operacion para el Identificador: [Numero de Identificador].' }];
