...
export class SimularLibreAmortizacionComponent {
  ...
  description = `Metodo para simular el alta de un prestamo libre amortizacion.`;
  ...
  inputData  = [{ Nombre: 'sdtPrestamo', Tipo: '[sBTPrestamoAltaLA](#sbtprestamoaltala)', Comentarios: 'Datos de la simulacion.' }, { Nombre: 'generaCuotaInteres', Tipo: 'String', Comentarios: 'Indica si se generan cuotas de intereses. [Hidden: Valores 'S'/'N'].' }];
