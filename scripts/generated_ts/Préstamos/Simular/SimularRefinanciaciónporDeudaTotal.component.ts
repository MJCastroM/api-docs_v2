...
@Component({
  selector: 'app-SimularRefinanciacinporDeudaTotal',
  templateUrl: './DocTemplate.component.html',
  styleUrls: ['./DocTemplate.component.scss'],
  animations: [ fadeInOut ],
  host: { '[@fadeInOut]': '' }
})
export class SimularRefinanciacionporDeudaTotalComponent {
  pageTitle = 'Simular Refinanciacion por Deuda Total';
  description = `Metodo para simular una refinanciacion de uno o mas prestamos, siendo el capital del nuevo prestamo la suma de la deuda total de los seleccionados.`;
...
:::`;
  ...
  inputData  = [{ Nombre: 'sdtRefinanciacion', Tipo: '[sBTRefinanciacionAlta](#sbtrefinanciacionalta)', Comentarios: 'Datos de simulacion.' }, { Nombre: 'accion', Tipo: 'String', Comentarios: '[Hidden: Valor fijo 'REFIT' para este metodo].' }];
