...
export class EliminarTextosComponent {
  pageTitle = 'Eliminar Textos';
  description = `Metodo para eliminar los textos de un prestamo.`;
  ...
  inputData  = [{ Nombre: 'operacionUId', Tipo: 'Long', Comentarios: 'Identificador unico de la operacion.' }, { Nombre: 'sdtTextos', Tipo: '[sBTTextoOperacion](#sbttextooperacion)', Comentarios: 'Listado de textos de la operacion.' }, { Nombre: 'modo', Tipo: 'String', Comentarios: '[Hidden: Valor fijo "DLT" para este metodo].' }];
  outputData = [];
