...
export class ObtenerProductosdelPartnerComponent {
  // Cabecera e info-card
  pageTitle = 'Obtener Productos del Partner';
  description = `Metodo para obtener los productos habilitados del Partner.`;
