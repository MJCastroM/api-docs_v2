...
export class ObtenerDetalledeOfertaAmortizableComponent {
  // Cabecera e info-card
  pageTitle = 'Obtener Detalle de Oferta Amortizable';
  description = `Metodo para obtener el detalle de la oferta amortizable del Partner.`;
  ...
  inputCols  = ['sdtPartner', 'simulacionUId', 'clienteUId', 'cantidadCuotas', 'destinoCredito'];
  inputData  = [{ Nombre: 'sdtPartner', Tipo: '[sBTPartnerInReq](#sbtpartnerinreq)', Comentarios: 'Datos del usuario.' }, { Nombre: 'simulacionUId', Tipo: 'Long', Comentarios: 'Identificador de la simulacion.' }, { Nombre: 'clienteUId', Tipo: 'Long', Comentarios: 'Identificador unico del cliente.' }, { Nombre: 'cantidadCuotas', Tipo: 'Int', Comentarios: 'Cantidad de cuotas.' }, { Nombre: 'destinoCredito', Tipo: 'Long', Comentarios: 'Destino del credito' }];
  ...
  errorCols  = ['30001', '30002', '30003', '30004', '30005', '30008', '30009', '30010', '30011', '30012', '30019', '30020'];
  errors     = [{ Codigo: '30001', Descripcion: 'No se recibio el identificador de simulacion.' }, { Codigo: '30002', Descripcion: 'No se recibio el identificador de cliente' }, { Codigo: '30003', Descripcion: 'No se recupero la cuenta para el Identificador: [Numero de Identificador].' }, { Codigo: '30004', Descripcion: 'La simulacion no corresponde al cliente: [Numero de Identificador].' }, { Codigo: '30005', Descripcion: 'La cantidad de cuotas indicada no forma parte de las ofertas.' }, { Codigo: '30008', Descripcion: 'No se recibio Partner ni canal.' }, { Codigo: '30009', Descripcion: 'El Partner no se encuentra habilitado.' }, { Codigo: '30010', Descripcion: 'No existe Partner con ese identificador.' }, { Codigo: '30011', Descripcion: 'La simulacion no esta vigente.' }, { Codigo: '30012', Descripcion: 'La simulacion no existe.' }, { Codigo: '30019', Descripcion: 'No se recibio punto de venta.' }, { Codigo: '30020', Descripcion: 'No se recibio vendedor.' }];
