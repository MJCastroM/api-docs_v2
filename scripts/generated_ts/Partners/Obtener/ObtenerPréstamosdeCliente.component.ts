...
@Component({
  selector: 'app-ObtenerPrstamosdeCliente',
  templateUrl: './DocTemplate.component.html',
  styleUrls: ['./DocTemplate.component.scss'],
  animations: [ fadeInOut ],
  host: { '[@fadeInOut]': '' }
})
export class ObtenerPrestamosdeClienteComponent {
  // Cabecera e info-card
  pageTitle = 'Obtener Prestamos de Cliente';
  description = `Metodo para obtener los prestamos de un cliente del Partner.`;
  ...
  inputCols  = ['sdtPartner', 'clienteUId'];
  inputData  = [{ Nombre: 'sdtPartner', Tipo: '[sBTPartnerInReq](#sbtpartnerinreq)', Comentarios: 'Datos del usuario.' }, { Nombre: 'clienteUId', Tipo: 'Long', Comentarios: 'Identificador unico del cliente.' }];
  outputCols = ['prestamos'];
  outputData = [{ Nombre: 'prestamos', Tipo: '[sBTProductoPrestamo](#sbtproductoprestamo)', Comentarios: 'Listado de prestamos.' }];
  errorCols  = ['30001', '30002', '30003', '30004', '30005', '30014', '30015'];
  errors     = [{ Codigo: '30001', Descripcion: 'No se recibio el identificador unico de cuenta.' }, { Codigo: '30002', Descripcion: 'No se recupero la cuenta para el Identificador: [Numero de Identificador].' }, { Codigo: '30003', Descripcion: 'No se recibio Partner ni canal.' }, { Codigo: '30004', Descripcion: 'El Partner no se encuentra habilitado.' }, { Codigo: '30005', Descripcion: 'No existe Partner con ese identificador.' }, { Codigo: '30014', Descripcion: 'No se recibio punto de venta.' }, { Codigo: '30015', Descripcion: 'No se recibio vendedor.' }];
