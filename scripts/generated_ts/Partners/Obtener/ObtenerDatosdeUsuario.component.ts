...
export class ObtenerDatosdeUsuarioComponent {
  // Cabecera e info-card
  pageTitle = 'Obtener Datos de Usuario';
  description = `Metodo para obtener el Partner, punto de venta e identificador de vendedor de usuario.`;
  ...
  inputCols  = ['usuarioUId'];
  inputData  = [{ Nombre: 'usuarioUId', Tipo: 'String', Comentarios: 'Identificador unico de usuario.' }];
  outputCols = ['sdtPartner'];
  ...
  errors     = [{ Codigo: '30001', Descripcion: 'No se recibio el usuario.' }, { Codigo: '30002', Descripcion: 'Usuario no registrado en Bantotal.' }, { Codigo: '30003', Descripcion: 'Usuario no registrado como vendedor.' }];
