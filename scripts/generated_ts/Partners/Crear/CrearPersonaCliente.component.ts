...
export class CrearPersonaClienteComponent {
  // Cabecera e info-card
  pageTitle = 'Crear Persona Cliente';
  description = `Metodo para crear persona de Partner.`;
  ...
  inputCols  = ['sdtPartner', 'sdtPersona'];
  inputData  = [{ Nombre: 'sdtPartner', Tipo: '[sBTPartnerInReq](#sbtpartnerinreq)', Comentarios: 'Datos del usuario.' }, { Nombre: 'sdtPersona', Tipo: '[sBTPersonaFisica](#sbtpersonafisica)', Comentarios: 'Datos de persona fisica.' }];
  outputCols = ['clienteUId'];
  outputData = [{ Nombre: 'clienteUId', Tipo: 'Long', Comentarios: 'Identificador unico de cliente.' }];
  errorCols  = ['30002', '30003'];
  errors     = [{ Codigo: '30002', Descripcion: 'La Contraparte ya esta relacionada al Partner: [Numero del Partner] - [Nombre del Partner].' }, { Codigo: '30003', Descripcion: 'No se pudo obtener identificador unico de la cuenta.' }];
