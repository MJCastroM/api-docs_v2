...
@Component({
  selector: 'app-CrearChequeraElectrnica',
  templateUrl: './DocTemplate.component.html',
  styleUrls: ['./DocTemplate.component.scss'],
  animations: [ fadeInOut ],
  host: { '[@fadeInOut]': '' }
})
export class CrearChequeraElectronicaComponent {
  pageTitle = 'Crear Chequera Electronica';
  description = `Metodo para crear una chequera electronica.`;
  ...
  inputData  = [{ Nombre: 'operacionUId', Tipo: 'Long', Comentarios: 'Identificador unico de operacion de subcuenta.' }, { Nombre: 'cantidadCheques', Tipo: 'Short', Comentarios: 'Cantidad de cheques.' }];
