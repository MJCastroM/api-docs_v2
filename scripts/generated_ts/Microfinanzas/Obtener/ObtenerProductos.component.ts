...
export class ObtenerProductosComponent {
  ...
  description = `Metodo para obtener una lista de los productos de prestamos.`;
  ...
  inputData  = [{ Nombre: 'solicitudUId', Tipo: 'Long', Comentarios: 'Identificador unico de solicitud.' }];
