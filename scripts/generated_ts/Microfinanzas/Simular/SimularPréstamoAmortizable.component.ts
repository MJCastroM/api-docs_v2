...
@Component({
  selector: 'app-SimularPrstamoAmortizable',
  templateUrl: './DocTemplate.component.html',
  styleUrls: ['./DocTemplate.component.scss'],
  animations: [ fadeInOut ],
  host: { '[@fadeInOut]': '' }
})
export class SimularAmortizableComponent {
  pageTitle = 'Simular Amortizable';
  description = `Metodo para simular el alta de un prestamo amortizable para un credito individual.`;
  ...
  inputData  = [{ Nombre: 'sBTSimulacionAmortizable', Tipo: '[sBTSimulacionAmortizable](#sbtsimulacionamortizable)', Comentarios: 'Datos de la simulacion.' }];
  outputData = [{ Nombre: 'sdtSimulacion', Tipo: '[sBTSimulacionPrestamo](#sbtsimulacionprestamo)', Comentarios: 'Datos del prestamo simulado.' }];
  errors     = [{ Codigo: '30001', Descripcion: 'No se recibio el identificador de la solicitud.' }, { Codigo: '30002', Descripcion: 'No se recibio el identificador de cliente.' }, { Codigo: '30003', Descripcion: 'No se recibio el identificador de producto.' }, { Codigo: '30004', Descripcion: 'No se recupero la cuenta para el Identificador [Numero de identificador].' }];
