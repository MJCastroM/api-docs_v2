...
@Component({
  selector: 'app-SimularPrstamoAmortizableGrupal',
  templateUrl: './DocTemplate.component.html',
  styleUrls: ['./DocTemplate.component.scss'],
  animations: [ fadeInOut ],
  host: { '[@fadeInOut]': '' }
})
export class SimularAmortizableGrupalComponent {
  pageTitle = 'Simular Amortizable Grupal';
  description = `Metodo para simular la solicitud de un prestamo amortizable grupal.`;
  ...
  inputData  = [{ Nombre: 'sdtSimulacionAmortizableGrupal', Tipo: '[sBTSimulacionAmortizableGrupal](#sbtsimulacionamortizablegrupal)', Comentarios: 'Datos de la simulacion grupal.' }];
  outputData = [{ Nombre: 'sdtSimulacionPrestamo', Tipo: '[sBTSimulacionPrestamo](#sbtsimulacionprestamo)', Comentarios: 'Datos del prestamo simulado.' }, { Nombre: 'sdtIntegrantesGrupo', Tipo: '[sBTIntegranteGrupoSolicitud](#sbtintegrantegruposolicitud)', Comentarios: 'Datos de los integrantes del grupo.' }];
  errors     = [{ Codigo: '30001', Descripcion: 'No se recibio el identificador de la solicitud.' }, { Codigo: '30002', Descripcion: 'No se recibio el identificador de producto.' }, { Codigo: '30003', Descripcion: 'No se recupero la cuenta para el Identificador: [Numero de identificador].' }, { Codigo: '30004', Descripcion: 'No se recibio ningun integrante del grupo.' }, { Codigo: '40001', Descripcion: 'El integrante no pertenece al grupo.' }];
