...
export class SimularAmortizableGrupalComponent {
  ...
  inputCols  = ['sdtSimulacionAmortizableGrupal'];
  ...
  outputCols = ['sdtSimulacionPrestamo', 'sdtIntegrantesGrupo'];
  ...
  errorCols  = ['30001', '30002', '30003', '30004', '40001'];
