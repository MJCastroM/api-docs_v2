...
export class AgregarIntegranteaGrupoComponent {
  pageTitle = 'Agregar Integrante a Grupo';
  description = `Metodo para agregar un integrante a un grupo de credito.`;
  ...
  inputData  = [{ Nombre: 'grupoId', Tipo: 'Int', Comentarios: 'Codigo de grupo' }, { Nombre: 'sdtIntegranteGrupo', Tipo: '[sBTIntegranteGrupo](#sbtintegrantegrupo)', Comentarios: 'Datos del integrante' }];
  outputData = [];
  errors     = [{ Codigo: '30001', Descripcion: 'No se recibio el identificador de grupo' }, { Codigo: '30002', Descripcion: 'No se recibio el identificador de cliente' }, { Codigo: '30014', Descripcion: 'No existe registro con el identificador indicado' }, { Codigo: '40005', Descripcion: 'Debe ingresar un tipo de integrante valido para el grupo' }, { Codigo: '40006', Descripcion: 'Excedio la cantidad de integrantes Coordinador permitidos para el tipo de grupo' }, { Codigo: '40008', Descripcion: 'La cuenta ya integra el grupo' }];
