...
export class ActualizarGrupoComponent {
  ...
  description = `Metodo para actualizar la informacion de un grupo de credito.`;
  ...
  inputCols  = ['grupoId', 'sdtDetalleGrupo'];
  ...
  outputCols = [];
  outputData = [];
  errorCols  = ['40002', '40003', '40013', '40005', '40006', '40007'];
