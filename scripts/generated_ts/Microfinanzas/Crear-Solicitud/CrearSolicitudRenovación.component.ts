...
@Component({
  selector: 'app-CrearSolicitudRenovacin',
  templateUrl: './DocTemplate.component.html',
  styleUrls: ['./DocTemplate.component.scss'],
  animations: [ fadeInOut ],
  host: { '[@fadeInOut]': '' }
})
export class CrearSolicitudRenovacionComponent {
  // Cabecera e info-card
  pageTitle = 'Crear Solicitud Renovacion';
  description = `Metodo para crear una solicitud de renovacion de credito.`;
