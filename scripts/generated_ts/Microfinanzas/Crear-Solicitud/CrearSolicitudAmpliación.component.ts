...
@Component({
  selector: 'app-CrearSolicitudAmpliacin',
  templateUrl: './DocTemplate.component.html',
  styleUrls: ['./DocTemplate.component.scss'],
  animations: [ fadeInOut ],
  host: { '[@fadeInOut]': '' }
})
export class CrearSolicitudAmpliacionComponent {
  pageTitle = 'Crear Solicitud Ampliacion';
  description = `Metodo para crear una solicitud de ampliacion de credito.`;
