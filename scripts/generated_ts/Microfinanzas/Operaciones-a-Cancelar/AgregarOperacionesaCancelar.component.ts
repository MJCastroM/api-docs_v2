...
export class AgregarOperacionesaCancelarComponent {
  // Cabecera e info-card
  pageTitle = 'Agregar Operaciones a Cancelar';
  description = `Metodo para agregar operaciones a cancelar para una solicitud de creditos.`;
  ...
  errorCols  = ['30001', '30002', '30003', '30004', '30005', '40001', '40002', '40003', '40004'];
  errors     = [{ Codigo: '30001', Descripcion: 'No se recibio el identificador de solicitud.' }, { Codigo: '30002', Descripcion: 'No se recibio el identificador de cliente.' }, { Codigo: '30003', Descripcion: 'No se recibio ninguna operacion para ampliar.' }, { Codigo: '30004', Descripcion: 'No se recupero la cuenta para el identificador de cliente: [Numero de identificador].' }, { Codigo: '30005', Descripcion: 'No se recupero la operacion para el identificador: [Numero de identificador].' }, { Codigo: '40001', Descripcion: 'La solicitud ingresada no existe.' }, { Codigo: '40002', Descripcion: 'El cliente ingresado no corresponde con la solicitud.' }, { Codigo: '40003', Descripcion: 'El maximo de creditos a cancelar no puede ser mayor a [Numero parametrizado].' }, { Codigo: '40004', Descripcion: 'La operacion ingresada ya fue dada de alta previamente.' }];
