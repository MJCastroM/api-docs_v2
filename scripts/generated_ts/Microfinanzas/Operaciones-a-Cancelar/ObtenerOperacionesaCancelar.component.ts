...
export class ObtenerOperacionesaCancelarComponent {
  // Cabecera e info-card
  pageTitle = 'Obtener Operaciones a Cancelar';
  description = `Metodo para obtener las operaciones seleccionadas a cancelar para una solicitud de creditos.`;
  ...
  errors     = [{ Codigo: '30001', Descripcion: 'No se recibio el identificador de solicitud.' }, { Codigo: '30002', Descripcion: 'No se recibio el identificador de cliente.' }, { Codigo: '30003', Descripcion: 'No se recupero la cuenta para el identificador de cliente: [Numero de identificador].' }, { Codigo: '40001', Descripcion: 'La solicitud ingresada no existe.' }, { Codigo: '40002', Descripcion: 'El cliente ingresado no corresponde con la solicitud.' }, { Codigo: '40003', Descripcion: 'No se encontraron operaciones para cancelar.' }];
