...
export class ObtenerCodigosdeDomicilioComponent {
  ...
  structuredTypes = [{ typeName: 'sBTCodigoDomicilio', fields: [{ Nombre: 'descripcion', Tipo: 'String', Comentarios: 'Descripcion de codigo de domicilio.' }, { Nombre: 'identificador', Tipo: 'Long', Comentarios: 'Identificador de codigo de domicilio.' }] }];
}
