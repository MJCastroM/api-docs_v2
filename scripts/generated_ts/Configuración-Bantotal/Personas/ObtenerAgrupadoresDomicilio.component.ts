...
export class ObtenerAgrupadoresDomicilioComponent1750713393593 {
    ...
    json: `
{
  ...
  structuredTypes = [{ typeName: 'sBTAgrupadores', fields: [{ Nombre: 'niveles', Tipo: '[sBTAgrupadorNiv1](#sbtagrupadorniv1)', Comentarios: 'Colección del primer subnivel de agrupación.' }] }, { typeName: 'sBTAgrupadorNiv1', fields: [{ Nombre: 'codigo', Tipo: 'Short', Comentarios: 'Código de agrupador.' }, { Nombre: 'descripcion', Tipo: 'String', Comentarios: 'Nombre de agrupador.' }, { Nombre: 'subNivel2', Tipo: '[sBTAgrupadorNiv2](#sbtagrupadorniv2)', Comentarios: 'Colección del segundo subnivel de agrupación.' }] }, { typeName: 'sBTAgrupadorNiv2', fields: [{ Nombre: 'codigo', Tipo: 'Short', Comentarios: 'Código de agrupador.' }, { Nombre: 'descripcion', Tipo: 'String', Comentarios: 'Nombre de agrupador.' }, { Nombre: 'subNivel3', Tipo: '[sBTAgrupadorNiv3](#sbtagrupadorniv3)', Comentarios: 'Colección del tercer subnivel de agrupación.' }] }, { typeName: 'sBTAgrupadorNiv3', fields: [{ Nombre: 'codigo', Tipo: 'Short', Comentarios: 'Código de agrupador.' }, { Nombre: 'descripcion', Tipo: 'String', Comentarios: 'Nombre de agrupador.' }, { Nombre: 'subNivel4', Tipo: '[sBTAgrupadorNiv4](#sbtagrupadorniv4)', Comentarios: 'Colección del cuarto subnivel de agrupación.' }] }, { typeName: 'sBTAgrupadorNiv4', fields: [{ Nombre: 'codigo', Tipo: 'Short', Comentarios: 'Código de agrupador.' }, { Nombre: 'descripcion', Tipo: 'String', Comentarios: 'Nombre de agrupador.' }, { Nombre: 'subNivel', Tipo: '[sBTAgrupadorNiv5](#sbtagrupadorniv5)', Comentarios: 'Colección del quinto subnivel de agrupación.' }] }, { typeName: 'sBTAgrupadorNiv5', fields: [{ Nombre: 'codigo', Tipo: 'Short', Comentarios: 'Código de agrupador.' }, { Nombre: 'descripcion', Tipo: 'String', Comentarios: 'Nombre de agrupador.' }, { Nombre: 'subNivel6', Tipo: '[sBTAgrupadorNiv6](#sbtagrupadorniv6)', Comentarios: 'Colección del quinto subnivel de agrupación.' }] }, { typeName: 'sBTAgrupadorNiv6', fields: [{ Nombre: 'codigo', Tipo: 'Short', Comentarios: 'Código de agrupador.' }, { Nombre: 'descripcion', Tipo: 'String', Comentarios: 'Nombre de agrupador.' }, { Nombre: ':::', Tipo: '', Comentarios: '' }] }];
}
