...
@Component({
  selector: 'app-ObtenerPases',
  templateUrl: './DocTemplate.component.html',
  styleUrls: ['./DocTemplate.component.scss'],
  animations: [ fadeInOut ],
  host: { '[@fadeInOut]': '' }
})
export class ObtenerPaisesComponent {
  // Cabecera e info-card
  pageTitle = 'Obtener Paises';
  description = `Metodo para obtener un listado de los paises ingresados en Bantotal.`;
  ...
  inputCols  = [];
  inputData  = [];
  outputCols = ['sdtPaises'];
  outputData = [{ Nombre: 'sdtPaises', Tipo: '[sBTPais](#sbtpais)', Comentarios: 'Listado de paises.' }];
  errorCols  = [];
  errors     = [];
