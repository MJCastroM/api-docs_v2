...
export class ObtenerTiposdeDocumentoDigitalComponent {
  // Cabecera e info-card
  pageTitle = 'Obtener Tipos de Documento Digital';
  description = `Metodo para obtener un listado de los tipos de documento digital ingresados en Bantotal.`;
  ...
  inputCols  = [];
  inputData  = [];
  outputCols = ['sdtTiposDeDocumentoDigital'];
