...
export class ObtenerTiposdeTarjetaComponent {
  ...
  // Datos estructurados
  structuredTypes = [{ Nombre: 'descripcion', Tipo: 'String', Comentarios: 'Descripcion de tipo de tarjeta.' }, { Nombre: 'identificador', Tipo: 'String', Comentarios: 'Identificador de tipo de tarjeta.' }, { Nombre: ':::', Tipo: '', Comentarios: '' }];
}
