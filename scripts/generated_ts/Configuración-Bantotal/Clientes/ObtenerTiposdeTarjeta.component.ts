...
export class ObtenerTiposdeTarjetaComponent {
  pageTitle = 'Obtener Tipos de Tarjeta';
  description = `Metodo para obtener un listado de los tipos de tarjeta ingresados en Bantotal.`;
  ...
  structuredTypes = [{ typeName: 'sBTTipoTarjeta', fields: [{ Nombre: 'descripcion', Tipo: 'String', Comentarios: 'Descripcion de tipo de tarjeta.' }, { Nombre: 'identificador', Tipo: 'String', Comentarios: 'Identificador de tipo de tarjeta.' }] }];
}
