...
export class ObtenerDetalleSucursalComponent1750713393525 {
...
\'{
  ...
  structuredTypes = [{ typeName: 'sBTDetalleSucursal', fields: [{ Nombre: 'barrio', Tipo: 'String', Comentarios: 'Barrio.' }, { Nombre: 'barrioId', Tipo: 'Int', Comentarios: 'Identificador del barrio.' }, { Nombre: 'calendarioId', Tipo: 'Short', Comentarios: 'Identificador de calendario.' }, { Nombre: 'calle', Tipo: 'String', Comentarios: 'Calle.' }, { Nombre: 'categoria', Tipo: 'String', Comentarios: 'Categoría.' }, { Nombre: 'categoriaId', Tipo: 'Int', Comentarios: 'Identificador de la categoría.' }, { Nombre: 'ciudad', Tipo: 'String', Comentarios: 'Ciudad.' }, { Nombre: 'ciudadId', Tipo: 'Int', Comentarios: 'Identificador de la ciudad.' }, { Nombre: 'codigo', Tipo: 'Int', Comentarios: 'Código.' }, { Nombre: 'codigoPostal', Tipo: 'String', Comentarios: 'Código postal.' }, { Nombre: 'departamento', Tipo: 'String', Comentarios: 'Departamento.' }, { Nombre: 'departamentoId', Tipo: 'Int', Comentarios: 'Identificador del departamento.' }, { Nombre: 'email', Tipo: 'String', Comentarios: 'Email.' }, { Nombre: 'estado', Tipo: 'String', Comentarios: 'Estado.' }, { Nombre: 'estadoId', Tipo: 'Short', Comentarios: 'Identificador del estado.' }, { Nombre: 'nombre', Tipo: 'String', Comentarios: 'Nombre de la sucursal.' }, { Nombre: 'nroPuerta', Tipo: 'Int', Comentarios: 'Número de puerta.' }, { Nombre: 'oficinaPrincipal', Tipo: 'String', Comentarios: 'Oficina principal.' }, { Nombre: 'oficinaPrincipalId', Tipo: 'Int', Comentarios: 'Identificador de la oficina principal.' }, { Nombre: 'telefono', Tipo: 'String', Comentarios: 'Teléfono de la sucursal.' }, { Nombre: ':::', Tipo: '', Comentarios: '' }] }];
}
