...
export class ObtenerTiposdeTextoComponent {
  ...
  structuredTypes = [{ typeName: 'sBTTipoTexto', fields: [{ Nombre: 'descripcion', Tipo: 'String', Comentarios: 'Descripcion de tipo de texto.' }, { Nombre: 'identificador', Tipo: 'Long', Comentarios: 'Identificador de tipo de texto.' }] }];
}
