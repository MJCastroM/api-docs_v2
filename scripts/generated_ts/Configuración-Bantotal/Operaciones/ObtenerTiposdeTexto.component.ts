...
@Component({
  selector: 'app-ObtenerTiposdeTexto',
  templateUrl: './DocTemplate.component.html',
  styleUrls: ['./DocTemplate.component.scss'],
  animations: [ fadeInOut ],
  host: { '[@fadeInOut]': '' }
})
export class ObtenerTiposdeTextoComponent {
  // Cabecera e info-card
  pageTitle = 'Obtener Tipos de Texto';
  description = `Metodo para obtener un listado de los tipos de texto ingresados en Bantotal.`;
  ...
  inputCols  = [];
  inputData  = [];
  outputCols = ['sdtTextos'];
  outputData = [{ Nombre: 'sdtTextos', Tipo: '[sBTTipoTexto](#sbttipotexto)', Comentarios: 'Listado de tipos de texto.' }];
  errorCols  = [];
  errors     = [];
  ...
  // Datos estructurados
  structuredTypes = [{ Nombre: 'descripcion', Tipo: 'String', Comentarios: 'Descripcion de tipo de texto.' }, { Nombre: 'identificador', Tipo: 'Long', Comentarios: 'Identificador de tipo de texto.' }, { Nombre: ':::', Tipo: '', Comentarios: '' }];
}
