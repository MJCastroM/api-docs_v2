...
export class ActualizarDomicilioComponent {
  ...
  description = `Metodo para actualizar los datos del domicilio de un cliente.`;
  ...
  inputCols  = ['clienteUId', 'domicilio'];
  inputData  = [{ Nombre: 'clienteUId', Tipo: 'Long', Comentarios: 'Identificador unico de cliente.' }, { Nombre: 'domicilio', Tipo: '[sBTDomicilioCompleto](#sbtdomiciliocompleto)', Comentarios: 'Datos del domicilio.' }];
  outputCols = [];
  outputData = [];
  errorCols  = ['30001', '30002', '30011'];
  errors     = [{ Codigo: '30001', Descripcion: 'No se recibio el identificador de la cuenta.' }, { Codigo: '30002', Descripcion: 'El identificador de la cuenta no es correcto.' }, { Codigo: '30011', Descripcion: 'Codigo de domicilio no valido.' }];
