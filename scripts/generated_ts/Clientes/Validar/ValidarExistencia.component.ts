...
export class ValidarExistenciaComponent {
  ...
  description = `Metodo para validar la existencia de un numero de cuenta en Bantotal.`;
  ...
  inputCols  = ['cuentaBT'];
  inputData  = [{ Nombre: 'cuentaBT', Tipo: 'Int', Comentarios: 'Numero de cuenta Bantotal.' }];
  outputCols = ['existe'];
