...
:::`;
  ...
  structuredTypes = [{ typeName: 'sBTProductoPlazoFijoCancelado', fields: [{ Nombre: 'capital', Tipo: 'Double', Comentarios: 'Capital del deposito.' }, { Nombre: 'fechaAlta', Tipo: 'Date', Comentarios: 'Fecha de alta del deposito.' }, { Nombre: 'fechaVencimiento', Tipo: 'Date', Comentarios: 'Fecha de vencimiento del deposito.' }, { Nombre: 'idOperacionBT', Tipo: 'String', Comentarios: 'Identificador String Bantotal (concatenacion de todos los conceptos claves de la operacion).' }, { Nombre: 'idOperacionFmt', Tipo: 'String', Comentarios: 'Identificador String (concatenacion de algunos conceptos claves de la operacion).' }, { Nombre: 'impuestos', Tipo: 'Double', Comentarios: 'Impuestos del deposito.' }, { Nombre: 'instruccion', Tipo: 'String', Comentarios: 'Descripcion de la instruccion del deposito.' }, { Nombre: 'instruccionCod', Tipo: 'Short', Comentarios: 'Codigo de instruccion.' }, { Nombre: 'intereses', Tipo: 'Double', Comentarios: 'Intereses del deposito.' }, { Nombre: 'operacionUId', Tipo: 'Long', Comentarios: 'Identificador unico de operacion.' }, { Nombre: 'plazo', Tipo: 'Int', Comentarios: 'Plazo del deposito.' }, { Nombre: 'producto', Tipo: '[sBTProducto](#sbtproducto)', Comentarios: 'Datos del producto.' }, { Nombre: 'sucursal', Tipo: 'String', Comentarios: 'Nombre de la sucursal.' }, { Nombre: 'tasaFinal', Tipo: 'Double', Comentarios: 'Tasa final del deposito.' }, { Nombre: 'tasaOriginal', Tipo: 'Double', Comentarios: 'Tasa original del deposito.' }, { Nombre: 'tipoTasa', Tipo: 'String', Comentarios: 'Descripcion del tipo de tasa.' }, { Nombre: '### sBTProducto', Tipo: '', Comentarios: '' }] }, { typeName: 'sBTProducto', fields: [{ Nombre: 'moneda', Tipo: 'String', Comentarios: 'Simbolo de la moneda.' }, { Nombre: 'nombre', Tipo: 'String', Comentarios: 'Nombre del producto.' }, { Nombre: 'otrosConceptos', Tipo: '[sBTConcepto](#sbtconcepto)', Comentarios: 'Datos de otros conceptos.' }, { Nombre: 'papel', Tipo: 'String', Comentarios: 'Simbolo del papel.' }, { Nombre: 'productoUId', Tipo: 'Long', Comentarios: 'Identificador unico de producto.' }, { Nombre: '### sBTConcepto', Tipo: '', Comentarios: '' }] }, { typeName: 'sBTConcepto', fields: [{ Nombre: 'concepto', Tipo: 'String', Comentarios: 'Concepto.' }, { Nombre: 'texto', Tipo: 'String', Comentarios: 'Texto.' }, { Nombre: 'valor', Tipo: 'Double', Comentarios: 'Importe.' }] }];
}
