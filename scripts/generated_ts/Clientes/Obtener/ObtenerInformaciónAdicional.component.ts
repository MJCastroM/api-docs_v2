...
export class ObtenerInformacionAdicionalComponent {
  ...
  description = `Metodo para obtener la informacion adicional de una cuenta cliente.`;
  ...
  errors     = [{ Codigo: '30001', Descripcion: 'No se recibio el identificador de cliente.' }, { Codigo: '30013', Descripcion: 'No existe registro para el identificador unico.' }];
