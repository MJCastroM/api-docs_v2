...
export class ObtenerCuentasCorrientesSaldoDisponibleComponent {
  // Cabecera e info-card
  pageTitle = 'Obtener Cuentas Corrientes (Saldo Disponible)';
  description = `Metodo para obtener los productos de cuenta corriente que tiene contratado un cliente, junto con su saldo disponible.`;
