...
export class ObtenerComponent {
  pageTitle = 'Obtener';
  description = `Metodo para obtener los datos de un cliente.`;
  pubName    = 'BTClientes.Obtener';
  programa   = 'RBTPG089';
  scope      = 'Global';
  ...
  outputData = [{ Nombre: 'sdtPersona', Tipo: '[sBTPersonaFisica](#sbtpersonafisica)', Comentarios: 'Datos de la persona fisica.' }];
