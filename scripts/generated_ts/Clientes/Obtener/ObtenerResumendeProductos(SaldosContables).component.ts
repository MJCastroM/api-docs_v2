...
export class ObtenerResumendeProductosSaldosContablesComponent {
  pageTitle = 'Obtener Resumen de Productos (Saldos Contables)';
  description = `Metodo para obtener un resumen de los productos de un cliente y su saldo contable correspondiente.`;
