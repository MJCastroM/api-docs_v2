...
@Component({
  selector: 'app-ObtenerIdentificadornico',
...
export class ObtenerIdentificadorUnicoComponent {
  ...
  description = `Metodo para obtener el identificador unico correspondiente a una cuenta cliente.`;
  ...
  outputCols = ['clienteUId', 'tipoDocumento', 'numeroDocumento', 'nombre', 'ejecutivo'];
  outputData = [{ Nombre: 'clienteUId', Tipo: 'Long', Comentarios: 'Identificador unico de cliente.' }, { Nombre: 'tipoDocumento', Tipo: 'String', Comentarios: 'Tipo de documento.' }, { Nombre: 'numeroDocumento', Tipo: 'String', Comentarios: 'Numero de documento.' }, { Nombre: 'nombre', Tipo: 'String', Comentarios: 'Nombre.' }, { Nombre: 'ejecutivo', Tipo: 'String', Comentarios: 'Ejecutivo.' }];
  errorCols  = ['30001'];
  errors     = [{ Codigo: '30001', Descripcion: 'No se recibio la Cuenta BT.' }];
