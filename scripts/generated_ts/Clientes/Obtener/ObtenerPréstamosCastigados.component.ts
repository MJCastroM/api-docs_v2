...
export class ObtenerPrestamosCastigadosComponent {
  ...
  backendText       = `Se debe parametrizar el modulo correspondiente a castigos ingresando en la guia especial 1041 los siguientes valores: 

Campo | Valor 
:--------- | :-----------  
Correlativo 1 | 1 
Correlativo 2 | 1 
Valor especifico 1 | Modulo correspondiente a castigos. 
Valor especifico 2 | 67 (Estado de operacion castigada). 
