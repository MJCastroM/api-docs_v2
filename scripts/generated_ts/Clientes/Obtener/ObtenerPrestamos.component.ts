...
export class ObtenerPrestamosComponent {
  pageTitle = 'Obtener Prestamos';
  description = `Metodo para obtener los prestamos de un cliente.`;
  ...
  inputData  = [{ Nombre: 'clienteUId', Tipo: 'Long', Comentarios: 'Identificador unico del cliente.' }, { Nombre: 'cancelado', Tipo: 'String', Comentarios: '[Hidden: Valor fijo '' para este metodo].' }];
