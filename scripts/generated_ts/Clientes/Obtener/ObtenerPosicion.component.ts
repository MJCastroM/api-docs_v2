...
export class ObtenerPosicionComponent {
  ...
  structuredTypes = [{ typeName: 'sBTClaseActivo', fields: [{ Nombre: 'identificador', Tipo: 'Long', Comentarios: 'Identificador de la clase de activo.' }, { Nombre: 'nombre', Tipo: 'String', Comentarios: 'Nombre de la clase de activo.' }, { Nombre: 'porcentajeComposicion', Tipo: 'Double', Comentarios: 'Porcentaje de composicion de la clase de activo.' }, { Nombre: 'total', Tipo: 'Double', Comentarios: 'Total de la clase de activo.' }] }];
}
