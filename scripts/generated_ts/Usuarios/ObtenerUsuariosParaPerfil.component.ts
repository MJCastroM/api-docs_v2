...
export class ObtenerUsuariosParaPerfilComponent1751987200503 {
  ...
  errors     = [{ Código: '30001', Descripción: 'Debe ingresar perfil.' }, { Código: '40001', Descripción: 'No existe el perfil ingresado.' }];
