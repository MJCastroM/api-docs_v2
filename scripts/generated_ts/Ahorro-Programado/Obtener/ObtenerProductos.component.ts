...
export class ObtenerProductosComponent {
  ...
  description = `Metodo para obtener un listado de los productos de ahorro programado habilitados.`;
  ...
  errorCols  = ['40001', '40002'];
  errors     = [{ Codigo: '40001', Descripcion: 'No es posible determinar los productos habilitados ya que ocurrio un error al recuperar la fecha del dia.' }, { Codigo: '40002', Descripcion: 'No se recupero productos habilitados para el producto de ahorro programado.' }];
