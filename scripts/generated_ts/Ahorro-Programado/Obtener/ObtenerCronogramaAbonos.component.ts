...
@Component({
  selector: 'app-ObtenerCronogramaAbonos',
  templateUrl: '../../DocTemplate.component.html',
  styleUrls: ['../../DocTemplate.component.scss'],
  animations: [ fadeInOut ],
  host: { '[@fadeInOut]': '' }
})
export class ObtenerCronogramaAbonosComponent1750713393053 {
...
\'{
  ...
  structuredTypes = [{ typeName: 'sBTSituacionAhorro', fields: [{ Nombre: 'abonos', Tipo: '[sBTAbono](#sbtabono)', Comentarios: 'Listado de abonos.' }, { Nombre: 'capitalAhorro', Tipo: 'Double', Comentarios: 'Capital.' }, { Nombre: 'clienteUId', Tipo: 'Long', Comentarios: 'Indentificador único del cliente.' }, { Nombre: 'estado', Tipo: 'String', Comentarios: 'Estado.' }, { Nombre: 'fechaProximoAbono', Tipo: 'Date', Comentarios: 'Fecha del proximo abono.' }, { Nombre: 'intereses', Tipo: 'Double', Comentarios: 'Intereses.' }, { Nombre: 'moneda', Tipo: 'String', Comentarios: 'Símbolo de la moneda.' }, { Nombre: 'operacionUId', Tipo: 'Long', Comentarios: 'Identificador único de la operación.' }, { Nombre: 'producto', Tipo: 'String', Comentarios: 'Nombre del producto.' }, { Nombre: 'sucursal', Tipo: 'String', Comentarios: 'Nombre de la sucursal.' }, { Nombre: 'titular', Tipo: 'String', Comentarios: 'Titular.' }, { Nombre: 'total', Tipo: 'Double', Comentarios: 'Total.' }] }, { typeName: 'sBTAbono', fields: [{ Nombre: 'abono', Tipo: 'Double', Comentarios: 'Abono.' }, { Nombre: 'capital', Tipo: 'Double', Comentarios: 'Capital del abono.' }, { Nombre: 'fechaPago', Tipo: 'Date', Comentarios: 'Fecha de pago.' }, { Nombre: 'intereses', Tipo: 'Double', Comentarios: 'Intereses del abono.' }, { Nombre: 'numeroAbono', Tipo: 'Int', Comentarios: 'Número de abono.' }, { Nombre: 'plazo', Tipo: 'int', Comentarios: 'Plazo del abono.' }, { Nombre: 'TAE', Tipo: 'Double', Comentarios: 'TAE.' }, { Nombre: 'TAN', Tipo: 'Double', Comentarios: 'TAN.' }, { Nombre: 'tasa', Tipo: 'Double', Comentarios: 'Tasa del abono.' }, { Nombre: ':::', Tipo: '', Comentarios: '' }] }];
}
