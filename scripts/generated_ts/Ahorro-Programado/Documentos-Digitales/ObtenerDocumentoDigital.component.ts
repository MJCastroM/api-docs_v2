...
export class ObtenerDocumentoDigitalComponent1751987195290 {
...
:::`;
  ...
  errors     = [{ Código: '30001', Descripción: 'No se recibió el identificador de la operación.' }, { Código: '30002', Descripción: 'No se recibió el identificador de documento.' }, { Código: '30003', Descripción: 'La operación ingresada no corresponde a un ahorro programado.' }, { Código: '30021', Descripción: 'No se recuperó la operación para el identificador recibido.' }, { Código: '30031', Descripción: 'El documento digital no existe.' }, { Código: '30032', Descripción: 'Ocurrió un error al obtener la última versión del documento.' }];
