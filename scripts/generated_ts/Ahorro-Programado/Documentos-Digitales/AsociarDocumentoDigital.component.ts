...
export class AsociarDocumentoDigitalComponent1751987195278 {
...
:::`;
  ...
  errors     = [{ Código: '30001', Descripción: 'No se recibió el identificador de tipo de documento digital.' }, { Código: '30002', Descripción: 'No se recibió nombre.' }, { Código: '30003', Descripción: 'No se recibió el identificador de la operación.' }, { Código: '30004', Descripción: 'No se recibió archivo codificado.' }, { Código: '30005', Descripción: 'La operación ingresada no corresponde a un ahorro programado.' }, { Código: '30021', Descripción: 'No se recuperó el identificador para la operación recibida.' }, { Código: '40101', Descripción: 'Ocurrió un error al recibir el archivo, puede que el mismo este corrupto.' }, { Código: '40993', Descripción: 'Error de configuración: El vínculo de un tipo de documento digital no puede estar vacío.' }, { Código: '40994', Descripción: 'Error de configuración: El vínculo de un tipo de documento digital no puede ser distinto al de la entidad invocadora.' }];
