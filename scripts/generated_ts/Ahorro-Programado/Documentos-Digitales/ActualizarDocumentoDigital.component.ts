...
export class ActualizarDocumentoDigitalComponent {
  ...
  description = `Metodo para actualizar un documento digital para un ahorro programado.`;
  ...
  outputCols = [];
  outputData = [];
  errorCols  = ['30001', '30002', '30003', '30004', '30021', '40101', '40993', '40994'];
  errors     = [{ Codigo: '30001', Descripcion: 'No se recibio el identificador de instancia de documento digital.' }, { Codigo: '30002', Descripcion: 'No se recibio nombre.' }, { Codigo: '30003', Descripcion: 'No se recibio el identificador de la operacion.' }, { Codigo: '30004', Descripcion: 'La operacion ingresada no corresponde a un ahorro programado.' }, { Codigo: '30021', Descripcion: 'No se recupero el identificador para la operacion recibida.' }, { Codigo: '40101', Descripcion: 'Ocurrio un error al recibir el archivo, puede que el mismo este corrupto.' }, { Codigo: '40993', Descripcion: 'Error de configuracion: El vinculo de un tipo de documento digital no puede estar vacio.' }, { Codigo: '40994', Descripcion: 'Error de configuracion: El vinculo de un tipo de documento digital no puede ser distinto al de la entidad invocadora.' }];
