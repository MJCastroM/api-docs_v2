...
@Component({
  selector: 'app-CrearCondicinImpositiva',
  templateUrl: './DocTemplate.component.html',
  styleUrls: ['./DocTemplate.component.scss'],
  animations: [ fadeInOut ],
  host: { '[@fadeInOut]': '' }
})
export class CrearCondicionImpositivaComponent {
  // Cabecera e info-card
  pageTitle = 'Crear Condicion Impositiva';
  description = `Metodo para dar de alta una condicion impositiva para una persona.`;
