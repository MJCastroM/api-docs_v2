...
@Component({
  selector: 'app-ObtenerPrximaFechaHbildeSucursal',
  templateUrl: './DocTemplate.component.html',
  styleUrls: ['./DocTemplate.component.scss'],
  animations: [ fadeInOut ],
  host: { '[@fadeInOut]': '' }
})
export class ObtenerProximaFechaHabildeSucursalComponent {
  pageTitle = 'Obtener Proxima Fecha Habil de Sucursal';
  description = `Metodo para obtener la proxima fecha habil a la fecha ingresada, para la sucursal recibida por parametro.`;
  ...
  inputData  = [{ Nombre: 'fecha', Tipo: 'Date', Comentarios: 'Fecha de consulta.' }, { Nombre: 'sucursalId', Tipo: 'Int', Comentarios: 'Identificador de sucursal.' }, { Nombre: 'sentido', Tipo: 'String', Comentarios: '[Hidden: Valor fijo 'A' para este metodo].' }];
  outputData = [{ Nombre: 'fechaHabil', Tipo: 'Date', Comentarios: 'Proxima fecha habil.' }];
