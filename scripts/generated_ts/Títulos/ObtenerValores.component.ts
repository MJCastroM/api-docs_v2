...
export class ObtenerValoresComponent {
  pageTitle = 'Obtener Valores';
  description = `Metodo para obtener los titulos disponibles para un grupo y sus respectivos valores.`;
  ...
  errors     = [{ Codigo: '30001', Descripcion: 'No se recibio el identificador del grupo.' }, { Codigo: '30002', Descripcion: 'No se pudieron obtener los titulos con el identificador ingresado.' }];
  ...
  structuredTypes = [{ typeName: 'sBTTitulo', fields: [{ Nombre: 'codigo', Tipo: 'Int', Comentarios: 'Codigo del titulo.' }, { Nombre: 'grupo', Tipo: 'String', Comentarios: 'Nombre del grupo.' }, { Nombre: 'grupoId', Tipo: 'Byte', Comentarios: 'Identificador del grupo.' }, { Nombre: 'moneda', Tipo: 'Short', Comentarios: 'Identificador de moneda.' }, { Nombre: 'nombre', Tipo: 'String', Comentarios: 'Nombre del titulo.' }, { Nombre: 'otrosConceptos', Tipo: '[sBTConcepto](#sbtconcepto)', Comentarios: 'Listado de otros conceptos.' }, { Nombre: 'pais', Tipo: 'String', Comentarios: 'Nombre del pais.' }, { Nombre: 'precioActual', Tipo: 'Double', Comentarios: 'Precio actual.' }, { Nombre: 'simbolo', Tipo: 'String', Comentarios: 'Simbolo de moneda.' }, { Nombre: '### sBTConcepto', Tipo: '', Comentarios: '' }] }, { typeName: 'sBTConcepto', fields: [{ Nombre: 'concepto', Tipo: 'String', Comentarios: 'Concepto.' }, { Nombre: 'texto', Tipo: 'String', Comentarios: 'Texto.' }, { Nombre: 'valor', Tipo: 'Double', Comentarios: 'Importe.' }] }];
}
