...
@Component({
  selector: 'app-EliminarPersonaVinculada',
  templateUrl: './DocTemplate.component.html',
  styleUrls: ['./DocTemplate.component.scss'],
  animations: [ fadeInOut ],
  host: { '[@fadeInOut]': '' }
})
export class EliminarPersonaVinculadaComponent {
  pageTitle = 'Eliminar Persona Vinculada';
  description = `Metodo para eliminar un vinculo de consanguinidad a una persona.`;
