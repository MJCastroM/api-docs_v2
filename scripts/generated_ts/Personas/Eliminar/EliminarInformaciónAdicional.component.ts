...
export class EliminarInformacionAdicionalComponent {
  ...
  description = `Metodo para eliminar la informacion adicional de una persona.`;
  ...
  inputData  = [{ Nombre: 'personaUId', Tipo: 'Long', Comentarios: 'Identificador unico de persona.' }, { Nombre: 'sdtInformacionAdicional', Tipo: '[sBTDatoLista](#sbtdatolista)', Comentarios: 'Listado de datos.' }, { Nombre: 'modo', Tipo: 'String', Comentarios: '[Hidden: Valor fijo 'DLT' para este metodo].' }];
  outputData = [];
  errors     = [{ Codigo: '30001', Descripcion: 'No se recibio el identificador de persona.' }, { Codigo: '40001', Descripcion: 'La persona ingresada no existe.' }];
