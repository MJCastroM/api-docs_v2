...
@Component({
  selector: 'app-ObtenerCorreosElectrnicos',
  templateUrl: './DocTemplate.component.html',
  styleUrls: ['./DocTemplate.component.scss'],
  animations: [ fadeInOut ],
  host: { '[@fadeInOut]': '' }
})
export class ObtenerCorreosElectronicosComponent {
  // Cabecera e info-card
  pageTitle = 'Obtener Correos Electronicos';
  description = `Metodo para obtener un listado de los correos electronicos de una persona.`;
  ...
  outputCols = ['sdtCorreoElectronicos'];
  outputData = [{ Nombre: 'sdtCorreoElectronicos', Tipo: '[sBTCorreoElectronico](#sbtcorreoelectronico)', Comentarios: 'Listado de correos electronicos.' }];
  errorCols  = ['30001'];
