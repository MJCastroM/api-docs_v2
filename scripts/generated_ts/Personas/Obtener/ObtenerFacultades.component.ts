...
export class ObtenerFacultadesComponent1750713394504 {
...
\'{
  ...
  structuredTypes = [{ typeName: 'sBTFacultadesPersona', fields: [{ Nombre: 'sBTFacultadesCliente', Tipo: '[sBTFacultadPersonaCliente](#sbtfacultadpersonacliente)', Comentarios: 'Listado de datos de cliente.' }, { Nombre: 'sBTFacultadesOperacion', Tipo: '[sBTFacultadPersonaOperacion](#sbtfacultadpersonaoperacion)', Comentarios: 'Listado de datos de operación.' }] }, { typeName: 'sBTFacultadPersonaCliente', fields: [{ Nombre: 'categoria', Tipo: 'String', Comentarios: 'Categoría.' }, { Nombre: 'clienteUId', Tipo: 'Long', Comentarios: 'Identificador único del cliente.' }, { Nombre: 'codigo', Tipo: 'Short', Comentarios: 'Código.' }, { Nombre: 'descripcion', Tipo: 'String', Comentarios: 'Descripción.' }, { Nombre: 'grupo', Tipo: '[sBTFacultadGrupoPersona](#sbtfacultadgrupopersona)', Comentarios: 'Listado de grupos de la facultad.' }, { Nombre: 'potestad', Tipo: 'String', Comentarios: 'Potestad.' }, { Nombre: 'tipo', Tipo: 'String', Comentarios: 'Tipo.' }] }, { typeName: 'sBTFacultadPersonaOperacion', fields: [{ Nombre: 'categoria', Tipo: 'String', Comentarios: 'Categoria.' }, { Nombre: 'codigo', Tipo: 'Short', Comentarios: 'Código.' }, { Nombre: 'descripcion', Tipo: 'String', Comentarios: 'Descripción.' }, { Nombre: 'grupo', Tipo: '[sBTFacultadGrupoPersona](#sbtfacultadgrupopersona)', Comentarios: 'Listado de grupos de la facultad.' }, { Nombre: 'operacionUId', Tipo: 'Long', Comentarios: 'Identificador único de la operación.' }, { Nombre: 'potestad', Tipo: 'String', Comentarios: 'Potestad.' }, { Nombre: 'producto', Tipo: '[sBTProducto](#sbtproducto)', Comentarios: 'Datos de producto.' }, { Nombre: 'tipo', Tipo: 'String', Comentarios: 'Tipo.' }] }, { typeName: 'sBTFacultadGrupoPersona', fields: [{ Nombre: 'codigoMoneda', Tipo: 'Int', Comentarios: 'Código de moneda.' }, { Nombre: 'codigoPapel', Tipo: 'Int', Comentarios: 'Código de papel.' }, { Nombre: 'moneda', Tipo: 'String', Comentarios: 'Moneda.' }, { Nombre: 'monto', Tipo: 'Decimal', Comentarios: 'Monto.' }, { Nombre: 'numero', Tipo: 'Short', Comentarios: 'Número de grupo.' }, { Nombre: 'papel', Tipo: 'String', Comentarios: 'Papel.' }, { Nombre: 'vigenciaDesde', Tipo: 'Date', Comentarios: 'Fecha de vigencia desde.' }, { Nombre: 'vigenciaHasta', Tipo: 'Date', Comentarios: 'Fecha de vigencia hasta.' }] }, { typeName: 'sBTProducto', fields: [{ Nombre: 'moneda', Tipo: 'String', Comentarios: 'Símbolo de la moneda.' }, { Nombre: 'nombre', Tipo: 'String', Comentarios: 'Nombre del producto.' }, { Nombre: 'otrosConceptos', Tipo: '[sBTConcepto](#sbtconcepto)', Comentarios: 'Datos de otros conceptos.' }, { Nombre: 'papel', Tipo: 'String', Comentarios: 'Símbolo del papel.' }, { Nombre: 'productoUId', Tipo: 'Long', Comentarios: 'Identificador único de producto.' }] }, { typeName: 'sBTConcepto', fields: [{ Nombre: 'concepto', Tipo: 'String', Comentarios: 'Concepto.' }, { Nombre: 'texto', Tipo: 'String', Comentarios: 'Texto.' }, { Nombre: 'valor', Tipo: 'Double', Comentarios: 'Importe.' }, { Nombre: ':::', Tipo: '', Comentarios: '' }] }];
}
