...
export class ObtenerIdBantotalComponent {
  // Cabecera e info-card
  pageTitle = 'Obtener Id Bantotal';
  description = `Metodo para obtener la clave de identificacion Bantotal de una persona.`;
  ...
  outputCols = ['paisDocumentoId', 'tipoDocumentoId', 'numeroDocumento'];
  outputData = [{ Nombre: 'paisDocumentoId', Tipo: 'Short', Comentarios: 'Identificador del pais de documento.' }, { Nombre: 'tipoDocumentoId', Tipo: 'Short', Comentarios: 'Identificador del tipo de documento.' }, { Nombre: 'numeroDocumento', Tipo: 'String', Comentarios: 'Numero de documento.' }];
  errorCols  = ['30001', '30002'];
  errors     = [{ Codigo: '30001', Descripcion: 'No se recibio el identificador de persona.' }, { Codigo: '30002', Descripcion: 'No existe registro para el identificador de persona ingresado.' }];
