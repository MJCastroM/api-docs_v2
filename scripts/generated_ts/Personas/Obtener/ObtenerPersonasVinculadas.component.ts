...
export class ObtenerPersonasVinculadasComponent1750446218786 {
...
{ 
  ...
  structuredTypes = [{ typeName: 'sBTPersonaVinculada', fields: [{ Nombre: 'nombre', Tipo: 'String', Comentarios: 'Nombre de la persona.' }, { Nombre: 'personaUId', Tipo: 'Long', Comentarios: 'Identificador único de persona.' }, { Nombre: 'vinculo', Tipo: '[sBTVinculo](#sbtvinculo)', Comentarios: 'Datos del vínculo.' }, { Nombre: '### sBTVinculo', Tipo: '', Comentarios: '' }] }, { typeName: 'sBTVinculo', fields: [{ Nombre: 'descripcion', Tipo: 'String', Comentarios: 'Descripción de vínculo.' }, { Nombre: 'identificador', Tipo: 'Short', Comentarios: 'Identificador de vínculo.' }, { Nombre: 'tipo', Tipo: 'String', Comentarios: 'Tipo de vínculo.' }] }];
}
