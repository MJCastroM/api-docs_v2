...
export class ObtenerTelefonosComponent {
  ...
  description = `Metodo para obtener los telefonos de una persona.`;
  ...
  errors     = [{ Codigo: '30001', Descripcion: 'No se recibio el identificador unico de persona.' }, { Codigo: '30013', Descripcion: 'No existe registro para el identificador unico.' }];
  ...
  // Datos estructurados
  structuredTypes = [{ Nombre: 'identificador', Tipo: 'Int', Comentarios: 'Identificador del tipo de telefono.' }, { Nombre: 'telefono', Tipo: 'String', Comentarios: 'Numero de telefono.' }, { Nombre: 'tipoDeDomicilio', Tipo: 'String', Comentarios: 'Nombre del tipo de domicilio.' }, { Nombre: 'tipoDeDomicilioId', Tipo: 'Byte', Comentarios: 'Identificador del tipo de domicilio.' }, { Nombre: ':::', Tipo: '', Comentarios: '' }];
}
