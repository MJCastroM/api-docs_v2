...
export class ObtenerTelefonosComponent {
  ...
  structuredTypes = [{ typeName: 'sBTTelefono', fields: [{ Nombre: 'identificador', Tipo: 'Int', Comentarios: 'Identificador del tipo de telefono.' }, { Nombre: 'telefono', Tipo: 'String', Comentarios: 'Numero de telefono.' }, { Nombre: 'tipoDeDomicilio', Tipo: 'String', Comentarios: 'Nombre del tipo de domicilio.' }, { Nombre: 'tipoDeDomicilioId', Tipo: 'Byte', Comentarios: 'Identificador del tipo de domicilio.' }] }];
}
