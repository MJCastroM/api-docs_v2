...
@Component({
  selector: 'app-ObtenerVnculos',
  templateUrl: './DocTemplate.component.html',
  styleUrls: ['./DocTemplate.component.scss'],
  animations: [ fadeInOut ],
  host: { '[@fadeInOut]': '' }
})
export class ObtenerVinculosComponent {
  // Cabecera e info-card
  pageTitle = 'Obtener Vinculos';
  description = `Metodo para obtener un listado de los vinculos registrados.`;
