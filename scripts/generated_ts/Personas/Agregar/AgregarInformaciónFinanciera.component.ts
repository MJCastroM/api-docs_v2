...
@Component({
  selector: 'app-AgregarInformacinFinanciera',
  templateUrl: './DocTemplate.component.html',
  styleUrls: ['./DocTemplate.component.scss'],
  animations: [ fadeInOut ],
  host: { '[@fadeInOut]': '' }
})
export class AgregarInformacionFinancieraComponent {
  pageTitle = 'Agregar Informacion Financiera';
  description = `Metodo para agregar la informacion financiera de una persona.`;
