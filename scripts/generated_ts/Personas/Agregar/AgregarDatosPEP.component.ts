...
export class AgregarDatosPEPComponent {
  ...
  inputCols  = ['personaUId', 'esPEP', 'sdtDatosPEP'];
  ...
  outputCols = [];
  outputData = [];
  errorCols  = ['30001', '30002', '30003', '50001', '50002', '50003', '50004', '50005'];
