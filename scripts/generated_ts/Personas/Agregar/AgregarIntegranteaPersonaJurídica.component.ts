...
@Component({
  selector: 'app-AgregarIntegranteaPersonaJurdica',
  templateUrl: './DocTemplate.component.html',
  styleUrls: ['./DocTemplate.component.scss'],
  animations: [ fadeInOut ],
  host: { '[@fadeInOut]': '' }
})
export class AgregarIntegranteaPersonaJuridicaComponent {
  // Cabecera e info-card
  pageTitle = 'Agregar Integrante a Persona Juridica';
  description = `Metodo para agregar un integrante a una persona juridica.`;
  ...
  inputData  = [{ Nombre: 'personaJuridicaUId', Tipo: 'Long', Comentarios: 'Identificador unico de persona juridica.' }, { Nombre: 'sdtIntegranteAlta', Tipo: '[sBTIntegranteJuridicoAlta](#sbtintegrantejuridicoalta)', Comentarios: 'Datos de la persona fisica integrante de la persona juridica indicada.' }, { Nombre: 'modo', Tipo: 'String', Comentarios: '[Hidden: Valor fijo 'INS' para este metodo].' }];
  outputCols = [];
  outputData = [];
  errorCols  = ['30001', '30002', '30003', '40001', '40003', '40004', '40005', '40006', '40007', '40008', '40009', '40010'];
  errors     = [{ Codigo: '30001', Descripcion: 'No se recibio identificador unico de persona juridica.' }, { Codigo: '30002', Descripcion: 'No se recibio identificador unico de integrante de persona juridica.' }, { Codigo: '30003', Descripcion: 'No se recibio identificador de vinculo del integrante de persona juridica.' }, { Codigo: '40001', Descripcion: 'La sumatoria de porcentajes asociados a los integrantes de la persona juridica es mayor al 100 %.' }, { Codigo: '40003', Descripcion: 'Debe ingresar el % de participacion del accionista.' }, { Codigo: '40004', Descripcion: 'El % de participacion no puede ser mayor al 100 %.' }, { Codigo: '40005', Descripcion: 'Si la persona no es Accionista, tiene que haber sido ingresada con Alta Normal para poder integrar a la persona.' }, { Codigo: '40006', Descripcion: 'Debe ingresar al menos un representante legal.' }, { Codigo: '40007', Descripcion: 'No se puede cambiar el vinculo, ya que es el unico Representante Legal.' }, { Codigo: '40008', Descripcion: 'La persona a vincular no puede ser la misma.' }, { Codigo: '40009', Descripcion: 'No puede asociar una persona juridica como representante legal.' }, { Codigo: '40010', Descripcion: 'No existe el identificador de vinculo ingresado.' }];
