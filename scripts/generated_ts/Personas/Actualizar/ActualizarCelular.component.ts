...
export class ActualizarCelularComponent {
  // Cabecera e info-card
  pageTitle = 'Actualizar Celular';
  description = `Metodo para actualizar el celular de una persona.`;
  ...
  inputCols  = ['personaUId', 'celular'];
  inputData  = [{ Nombre: 'personaUId', Tipo: 'Long', Comentarios: 'Identificador unico de la persona.' }, { Nombre: 'celular', Tipo: 'String', Comentarios: 'Numero de celular.' }];
  outputCols = [];
  outputData = [];
  errorCols  = ['30001', '30002', '30003', '30006', '30009'];
  errors     = [{ Codigo: '30001', Descripcion: 'No se recibio el identificador unico de persona.' }, { Codigo: '30002', Descripcion: 'No se recibio el numero de celular.' }, { Codigo: '30003', Descripcion: 'No existe registro para el identificador unico.' }, { Codigo: '30006', Descripcion: 'La persona no existe.' }, { Codigo: '30009', Descripcion: 'No existe numero de celular.' }];
