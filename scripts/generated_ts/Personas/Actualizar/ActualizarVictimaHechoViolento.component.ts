...
export class ActualizarVictimaHechoViolentoComponent1751987198379 {
  ...
  outputData = [];
  errors     = [{ Código: '30001', Descripción: 'No se recibió identificador de persona.' }, { Código: '40001', Descripción: 'Debe ingresar entidad.' }, { Código: '40002', Descripción: 'La entidad ingresada no es válida.' }, { Código: '40003', Descripción: 'Debe ingresar fecha del hecho.' }, { Código: '40004', Descripción: 'La fecha del hecho no puede ser posterior a la fecha de apertura.' }, { Código: '40005', Descripción: 'Debe ingresar fecha de certificación.' }, { Código: '40006', Descripción: 'La fecha de certificación no puede ser anterior a la fecha del hecho.' }, { Código: '40007', Descripción: 'Debe ingresar fecha de vencimiento.' }, { Código: '40008', Descripción: 'La fecha de vencimiento no puede ser anterior a la fecha del hecho.' }, { Código: '40009', Descripción: 'La fecha de vencimiento no puede ser anterior a la fecha de certificación.' }, { Código: '40011', Descripción: 'El departamento ingresado no es válido.' }, { Código: '40013', Descripción: 'El municipio ingresado no es válido.' }, { Código: '40019', Descripción: 'El tipo de hecho ingresado no es válido.' }, { Código: '40020', Descripción: 'No existe registro.' }];
