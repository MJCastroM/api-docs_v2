...
export class ActualizarReferenciaComponent {
  // Cabecera e info-card
  pageTitle = 'Actualizar Referencia';
  description = `Metodo para actualizar una referencia de una persona.`;
