...
export class ObtenerDocumentosDigitalesComponent {
  ...
  description = `Metodo para obtener un listado de los documentos digitales de una persona.`;
  ...
  errors     = [{ Codigo: '30001', Descripcion: 'No se recibio el identificador de la persona.' }, { Codigo: '30023', Descripcion: 'No existe registro para el identificador unico.' }, { Codigo: '30050', Descripcion: 'La persona indicada no existe.' }];
