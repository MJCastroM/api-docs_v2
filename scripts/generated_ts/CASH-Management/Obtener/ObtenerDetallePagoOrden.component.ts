...
export class ObtenerDetalledePagodeunaOrdenComponent {
  // Cabecera e info-card
  pageTitle = 'Obtener Detalle de Pago de una Orden';
  description = `Metodo para obtener la informacion de las lineas del detalle del pago para una orden.`;
  ...
  // Datos estructurados
  structuredTypes = [{ Nombre: 'nombre', Tipo: 'String', Comentarios: 'Nombre del Beneficiario de Pago.' }, { Nombre: 'beneficiarioId', Tipo: 'String', Comentarios: 'Identificador de Beneficiario.' }, { Nombre: 'beneficiarioCuenta', Tipo: 'String', Comentarios: 'Cuenta del Beneficiario.' }, { Nombre: 'beneficiarioBanco', Tipo: 'String', Comentarios: 'Banco del Beneficiario.' }, { Nombre: 'fechaPago', Tipo: 'Date', Comentarios: 'Fecha de Pago o Cobro.' }, { Nombre: 'moneda', Tipo: 'Short', Comentarios: 'Moneda.' }, { Nombre: 'importe', Tipo: 'Double', Comentarios: 'Importe.' }, { Nombre: 'estado', Tipo: 'String', Comentarios: 'Estado de la linea.' }, { Nombre: 'mensajesError', Tipo: 'String', Comentarios: 'Lista de mensajes de la linea.' }, { Nombre: ':::', Tipo: '', Comentarios: '' }];
}
