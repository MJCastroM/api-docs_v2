...
export class ObtenerDetalledeOrdendeCuentaComponent {
  // Cabecera e info-card
  pageTitle = 'Obtener Detalle de Orden de Cuenta';
  description = `Metodo para obtener la informacion de las lineas del detalle de orden de cuenta.`;
  ...
  inputCols  = ['ordenId', 'clienteUId'];
  inputData  = [{ Nombre: 'ordenId', Tipo: 'Long', Comentarios: 'Identificador de orden.' }, { Nombre: 'clienteUId', Tipo: 'Long', Comentarios: 'Identificador unico de cliente.' }];
  ...
  errorCols  = ['1030712', '1030713', '1030770', '1039999'];
  errors     = [{ Codigo: '1030712', Descripcion: 'Se requiere cuenta para recuperar la informacion.' }, { Codigo: '1030713', Descripcion: 'El contrato consultado no corresponde a la cuenta recibida.' }, { Codigo: '1030770', Descripcion: 'No se recupero informacion para la cuenta recibida.' }, { Codigo: '1039999', Descripcion: 'Error no clasificado' }];
