...
export class RegistrarPagodeDeudaComponent {
  // Cabecera e info-card
  pageTitle = 'Registrar Pago de Deuda';
  description = `Metodo para registrar el pago de una factura realizado en canal externo.`;
