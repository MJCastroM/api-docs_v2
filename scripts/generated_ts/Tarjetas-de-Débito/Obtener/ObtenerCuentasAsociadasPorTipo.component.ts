...
export class ObtenerCuentasAsociadasPorTipoComponent {
  // Cabecera e info-card
  pageTitle = 'Obtener Cuentas Asociadas Por Tipo';
  description = `Metodo para obtener un listado de las cuentas del tipo ingresado para una tarjeta de debito.`;
  ...
  inputCols  = ['tarjetaUId', 'tipoDeCuenta'];
  inputData  = [{ Nombre: 'tarjetaUId', Tipo: 'Long', Comentarios: 'Identificador unico de tarjeta.' }, { Nombre: 'tipoDeCuenta', Tipo: 'Short', Comentarios: 'Tipo de cuenta.' }];
  outputCols = ['sdtCuentasAsociadasTD'];
  ...
  errorCols  = ['30001'];
  errors     = [{ Codigo: '30001', Descripcion: 'No se recibio el Identificador de cuenta.' }];
