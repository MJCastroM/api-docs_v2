...
export class ObtenerCuentasAsociadasComponent {
  pageTitle = 'Obtener Cuentas Asociadas';
  description = `Metodo para obtener las cuentas a las que esta asociada una tarjeta de debito.`;
