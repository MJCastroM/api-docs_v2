...
@Component({
  selector: 'app-ModificarLmite',
  templateUrl: './DocTemplate.component.html',
  styleUrls: ['./DocTemplate.component.scss'],
  animations: [ fadeInOut ],
  host: { '[@fadeInOut]': '' }
})
export class ModificarLimiteComponent {
  // Cabecera e info-card
  pageTitle = 'Modificar Limite';
  description = `Metodo para modificar el limite de una tarjeta de debito.`;
  ...
  inputCols  = ['tarjetaUId', 'codigoDeLimiteId'];
  inputData  = [{ Nombre: 'tarjetaUId', Tipo: 'Long', Comentarios: 'Identificador de la tarjeta de debito.' }, { Nombre: 'codigoDeLimiteId', Tipo: 'Short', Comentarios: 'Codigo de limite.' }];
  outputCols = [];
  outputData = [];
  errorCols  = ['30001', '30002', '40001', '40002', '40014', '40001'];
  errors     = [{ Codigo: '30001', Descripcion: 'No se recibio identificador de tarjeta.' }, { Codigo: '30002', Descripcion: 'No se recibio codigo de limite' }, { Codigo: '40001', Descripcion: 'No existe el tipo de limite' }, { Codigo: '40002', Descripcion: 'No existe la tarjeta' }, { Codigo: '40014', Descripcion: 'No se pudo confirmar la funcionalidad.' }, { Codigo: '40001', Descripcion: 'No existe la tarjeta.' }];
