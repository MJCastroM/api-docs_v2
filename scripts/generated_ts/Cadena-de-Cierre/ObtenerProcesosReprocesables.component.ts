...
export class ObtenerProcesosReprocesablesComponent {
  // Cabecera e info-card
  pageTitle = 'Obtener Procesos Reprocesables';
  description = `Metodo para obtener un listado de los procesos reprocesables de la cadena de cierre.`;
  ...
  outputData = [{ Nombre: 'sdtProcesosBatch', Tipo: '[sBTProcesoBatch](#sbtprocesobatch)', Comentarios: 'Coleccion de procesos de cadena de cierre.' }];
  errorCols  = [];
  errors     = [];
