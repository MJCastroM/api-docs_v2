...
export class ObtenerDetalledeProcesoComponent {
  // Cabecera e info-card
  pageTitle = 'Obtener Detalle de Proceso';
  description = `Metodo para obtener el detalle de un proceso de la cadena de cierre.`;
