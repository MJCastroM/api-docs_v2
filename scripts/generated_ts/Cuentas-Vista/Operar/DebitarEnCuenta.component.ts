...
export class DebitarenCuentaComponent {
  pageTitle = 'Debitar en Cuenta';
  description = `Metodo para realizar un debito de una cuenta vista determinada.`;
  ...
  backendText       = `1) Definir la transaccion de debito, teniendo en cuenta que:
...
:::`;
  ...
  inputData  = [{ Nombre: 'sdtDatosDebitar', Tipo: '[sBTDatosAcreditarDebitar](#sbtdatosacreditardebitar)', Comentarios: 'Datos del debito.' }];
