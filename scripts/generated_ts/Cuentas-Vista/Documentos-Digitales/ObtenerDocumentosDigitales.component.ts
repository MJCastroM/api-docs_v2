...
export class ObtenerDocumentosDigitalesComponent {
  ...
  description = `Metodo para obtener un listado de los documentos digitales asociados a una cuenta vista.`;
  ...
  backendText       = `Si no se ingresa valor en el parametro 'sucursalId', su valor se asume de la cuenta cliente. Si la opcion general 3282 esta activada se tomara la sucursal del usuario que ejecuta el servicio.
...
:::`;
  ...
  errors     = [{ Codigo: '30001', Descripcion: 'No se recibio el identificador de la operacion.' }, { Codigo: '30004', Descripcion: 'La operacion ingresada no corresponde a una cuenta vista.' }, { Codigo: '30021', Descripcion: 'No se recupero la operacion para el identificador recibido.' }];
  ...
  structuredTypes = [{ typeName: 'sBTDocumentoDigital', fields: [{ Nombre: 'documentoId', Tipo: 'Long', Comentarios: 'documentoId del documento digital.' }, { Nombre: 'fechaActualizacion', Tipo: 'Date', Comentarios: 'Fecha de actualizacion del documento digital.' }, { Nombre: 'fechaVencimiento', Tipo: 'Date', Comentarios: 'Fecha de vencimiento del documento digital.' }, { Nombre: 'tipoDocumentoDigital', Tipo: 'String', Comentarios: 'Tipo del documento digital.' }, { Nombre: 'titulo', Tipo: 'String', Comentarios: 'Titulo del documento digital.' }] }];
}
