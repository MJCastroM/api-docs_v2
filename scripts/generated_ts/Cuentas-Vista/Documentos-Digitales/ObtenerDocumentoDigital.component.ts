...
export class ObtenerDocumentoDigitalComponent {
  ...
  description = `Metodo para obtener los datos de un documento digital de una cuenta vista.`;
  ...
  errorCols  = ['30001', '30002', '30004', '30021', '30031', '30032'];
  errors     = [{ Codigo: '30001', Descripcion: 'No se recibio el identificador de la operacion.' }, { Codigo: '30002', Descripcion: 'No se recibio el identificador de documento.' }, { Codigo: '30004', Descripcion: 'La operacion ingresada no corresponde a una cuenta vista.' }, { Codigo: '30021', Descripcion: 'No se recupero la operacion para el identificador recibido.' }, { Codigo: '30031', Descripcion: 'El documento digital no existe.' }, { Codigo: '30032', Descripcion: 'Ocurrio un error al obtener la ultima version del documento.' }];
