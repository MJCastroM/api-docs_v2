...
export class TraspasarEntreCuentasMismoTitularcontipodecambioComponent {
  // Cabecera e info-card
  pageTitle = 'Traspasar Entre Cuentas Mismo Titular (con tipo de cambio)';
  description = `Metodo para realizar un traspaso con cotizacion entre cuentas cuyo titular sea la misma persona.`;
  ...
  errorCols  = ['30001', '30002', '30003', '30004', '30005', '30006', '30007', '30008', '30009', '30010', '31003'];
  errors     = [{ Codigo: '30001', Descripcion: 'No se recibio el identificador de cliente.' }, { Codigo: '30002', Descripcion: 'No se recupero la cuenta para el Identificador.' }, { Codigo: '30003', Descripcion: 'No se recibio el identificador unico de operacion de origen.' }, { Codigo: '30004', Descripcion: 'No se recibio el identificador unico de operacion de destino.' }, { Codigo: '30005', Descripcion: 'Debe ingresar importe.' }, { Codigo: '30006', Descripcion: 'No se recibio el identificador de persona.' }, { Codigo: '30007', Descripcion: 'No se recupero la operacion origen para el Identificador: [Numero de identificador].' }, { Codigo: '30008', Descripcion: 'La operacion origen no pertenece al cliente.' }, { Codigo: '30009', Descripcion: 'No se recupero la operacion destino para el Identificador: [Numero de identificador].' }, { Codigo: '30010', Descripcion: 'Debe ingresar tipo de cambio a aplicar.' }, { Codigo: '31003', Descripcion: 'No existe registro para el identificador unico.' }];
