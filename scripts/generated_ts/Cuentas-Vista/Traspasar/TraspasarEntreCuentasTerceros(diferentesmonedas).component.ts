...
@Component({
  selector: 'app-TraspasarEntreCuentasTercerosdiferentesmonedas',
  templateUrl: './DocTemplate.component.html',
  styleUrls: ['./DocTemplate.component.scss'],
  animations: [ fadeInOut ],
  host: { '[@fadeInOut]': '' }
})
export class TraspasarEntreCuentasTercerosdiferentesmonedasComponent {
  // Cabecera e info-card
  pageTitle = 'Traspasar Entre Cuentas Terceros (diferentes monedas)';
  description = `Metodo para realizar un traspaso entre cuentas de diferente moneada, de diferentes clientes.`;
