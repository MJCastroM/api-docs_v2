...
export class ObtenerSaldosBloqueadosComponent {
  // Cabecera e info-card
  pageTitle = 'Obtener Saldos Bloqueados';
  description = `Metodo para obtener los saldos bloqueados de una cuenta vista.`;
  ...
  outputCols = ['sdtSaldosBloqueados'];
  ...
  errors     = [{ Codigo: '30001', Descripcion: 'No se recibio el identificador de operacion.' }, { Codigo: '30002', Descripcion: 'No se encontro el identificador de la operacion para la cuenta vista bloqueada.' }];
  ...
  // Datos estructurados
  structuredTypes = [{ Nombre: 'bloqueoId', Tipo: 'Long', Comentarios: 'Identificador del bloqueo.' }, { Nombre: 'fechaVencimiento', Tipo: 'Date', Comentarios: 'Fecha de vencimiento.' }, { Nombre: 'importe', Tipo: 'Double', Comentarios: 'Importe.' }, { Nombre: 'motivo', Tipo: 'String', Comentarios: 'Motivo.' }, { Nombre: ':::', Tipo: '', Comentarios: '' }];
}
