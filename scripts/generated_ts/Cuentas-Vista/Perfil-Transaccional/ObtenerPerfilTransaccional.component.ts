...
export class ObtenerPerfilTransaccionalComponent {
  // Cabecera e info-card
  pageTitle = 'Obtener Perfil Transaccional';
  description = `Metodo para obtener el perfil transaccional de una cuenta vista.`;
  ...
  outputCols = ['sdtPerfilTransaccional', 'totalCantidadDepositos', 'totalCantidadRetiros', 'totalMontoDepositos', 'totalMontoRetiros'];
  outputData = [{ Nombre: 'sdtPerfilTransaccional', Tipo: '[sBTDatosPerfilTransaccional](#sbtdatosperfiltransaccional)', Comentarios: 'Datos del perfil transaccional.' }, { Nombre: 'totalCantidadDepositos', Tipo: 'Int', Comentarios: 'Total de movimientos de depositos.' }, { Nombre: 'totalCantidadRetiros', Tipo: 'Int', Comentarios: 'Total de movimientos de retiros.' }, { Nombre: 'totalMontoDepositos', Tipo: 'Double', Comentarios: 'Total de importes de depositos.' }, { Nombre: 'totalMontoRetiros', Tipo: 'Double', Comentarios: 'Total de importes de retiros.' }];
  errorCols  = ['30001', '30021', '40001'];
  errors     = [{ Codigo: '30001', Descripcion: 'No se recibio el identificador unico de operacion.' }, { Codigo: '30021', Descripcion: 'No se recupero la operacion para el Identificador: [Numero de identificador].' }, { Codigo: '40001', Descripcion: 'Producto a consultar no existe.' }];
