...
export class ActualizarPerfilTransaccionalComponent1750713393850 {
...
\'{
  ...
  structuredTypes = [{ typeName: 'sBTDatosPerfilTransaccional', fields: [{ Nombre: 'origenDeFondosId', Tipo: 'Short', Comentarios: 'Identificador del origen de los fondos.' }, { Nombre: 'origenDeFondos', Tipo: 'String', Comentarios: 'Origen de los fondos.' }, { Nombre: 'movimientosMensuales', Tipo: '[sBTPerfilTrnMovimientosMensuales](#sbtperfiltrnmovimientosmensuales)', Comentarios: 'Datos de los movimientos mensuales.' }] }, { typeName: 'sBTPerfilTrnMovimientosMensuales', fields: [{ Nombre: 'enEfectivo', Tipo: '[sBTPerfilTrnDatosMovimientos](#sbtperfiltrndatosmovimientos)', Comentarios: 'Datos de los movimientos mensuales en efectivo.' }, { Nombre: 'conCheque', Tipo: '[sBTPerfilTrnDatosMovimientos](#sbtperfiltrndatosmovimientos)', Comentarios: 'Datos de los movimientos mensuales con cheques.' }, { Nombre: 'transferenciaLocal', Tipo: '[sBTPerfilTrnDatosMovimientos](#sbtperfiltrndatosmovimientos)', Comentarios: 'Datos de los movimientos mensuales de transferencias locales.' }, { Nombre: 'transferenciaInternacional', Tipo: '[sBTPerfilTrnDatosMovInternacionales](#sbtperfiltrndatosmovinternacionales)', Comentarios: 'Datos de los movimientos mensuales de transferencias internacionales.' }] }, { typeName: 'sBTPerfilTrnDatosMovimientos', fields: [{ Nombre: 'montoRetiros', Tipo: 'Double', Comentarios: 'Total de importes de retiros.' }, { Nombre: 'montoDepositos', Tipo: 'Double', Comentarios: 'Total de importes de depósitos.' }, { Nombre: 'cantidadDepositos', Tipo: 'int', Comentarios: 'Cantidad de movimientos de depósitos.' }, { Nombre: 'cantidadRetiros', Tipo: 'int', Comentarios: 'Cantidad de movimientos de retiros.' }] }, { typeName: 'sBTPerfilTrnDatosMovInternacionales', fields: [{ Nombre: 'montoRetiros', Tipo: 'Double', Comentarios: 'Total de importes de retiros.' }, { Nombre: 'montoDepositos', Tipo: 'Double', Comentarios: 'Total de importes de depósitos.' }, { Nombre: 'cantidadDepositos', Tipo: 'int', Comentarios: 'Cantidad de movimientos de depósitos.' }, { Nombre: 'cantidadRetiros', Tipo: 'int', Comentarios: 'Cantidad de movimientos de retiros.' }, { Nombre: 'paisOrigenId', Tipo: 'int', Comentarios: 'Identificador del país.' }, { Nombre: 'paisOrigen', Tipo: 'String', Comentarios: 'Nombre del país.' }, { Nombre: 'paisDestinoId', Tipo: 'int', Comentarios: 'Identificador del país.' }, { Nombre: 'paisDestino', Tipo: 'String', Comentarios: 'Nombre del país.' }, { Nombre: ':::', Tipo: '', Comentarios: '' }] }];
}
