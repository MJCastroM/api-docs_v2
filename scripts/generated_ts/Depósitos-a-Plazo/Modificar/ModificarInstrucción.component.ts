...
export class ModificarInstruccionComponent {
  ...
  backendText       = `Se debe parametrizar en la guia de procesos 70101 de la siguiente manera: 

Campo | Valor 
:--------- | :----------- 
Correlativo | Valor incremental. 
Valor especifico | Codigo de instruccion habilitada. 
Importe especifico | 3. 
:::`;
  backendConfig     = [];
