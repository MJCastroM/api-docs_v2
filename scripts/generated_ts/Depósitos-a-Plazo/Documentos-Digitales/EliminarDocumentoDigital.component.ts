...
export class EliminarDocumentoDigitalComponent {
  ...
  description = `Metodo para eliminar un documento digital de un deposito a plazo.`;
  ...
  errors     = [{ Codigo: '30001', Descripcion: 'No se recibio el identificador de instancia de documento digital.' }, { Codigo: '30002', Descripcion: 'No se recibio el identificador de la operacion.' }, { Codigo: '30003', Descripcion: 'La operacion ingresada no corresponde a un deposito a plazo.' }, { Codigo: '30021', Descripcion: 'No se recupero la operacion para el identificador recibido.' }, { Codigo: '40993', Descripcion: 'Error de configuracion: El vinculo de un tipo de documento digital no puede estar vacio.' }, { Codigo: '40994', Descripcion: 'Error de configuracion: El vinculo de un tipo de documento digital no puede ser distinto al de la entidad invocadora.' }];
