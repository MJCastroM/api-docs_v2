...
export class AsociarDocumentoDigitalComponent {
  ...
  description = `Metodo para asociar un documento digital a un deposito a plazo.`;
...
:::`;
  ...
  errors     = [{ Codigo: '30001', Descripcion: 'No se recibio el identificador de tipo de documento digital.' }, { Codigo: '30002', Descripcion: 'No se recibio nombre.' }, { Codigo: '30003', Descripcion: 'No se recibio el identificador de la operacion.' }, { Codigo: '30004', Descripcion: 'No se recibio archivo codificado.' }, { Codigo: '30005', Descripcion: 'La operacion ingresada no corresponde a un deposito a plazo.' }, { Codigo: '30021', Descripcion: 'No se recupero el identificador para la operacion recibida.' }, { Codigo: '40101', Descripcion: 'Ocurrio un error al recibir el archivo, puede que el mismo este corrupto.' }, { Codigo: '40993', Descripcion: 'Error de configuracion: El vinculo de un tipo de documento digital no puede estar vacio.' }, { Codigo: '40994', Descripcion: 'Error de configuracion: El vinculo de un tipo de documento digital no puede ser distinto al de la entidad invocadora.' }];
