...
@Component({
  selector: 'app-AutorizarExcepcin',
  templateUrl: './DocTemplate.component.html',
  styleUrls: ['./DocTemplate.component.scss'],
  animations: [ fadeInOut ],
  host: { '[@fadeInOut]': '' }
})
export class AutorizarExcepcionComponent {
  // Cabecera e info-card
  pageTitle = 'Autorizar Excepcion';
  description = `Metodo para autorizar una excepcion.`;
  ...
  inputData  = [{ Nombre: 'idExcepcion', Tipo: 'Int', Comentarios: 'Identificador de excepcion.' }, { Nombre: 'usuario', Tipo: 'String', Comentarios: 'Usuario.' }, { Nombre: 'contrasena', Tipo: 'String', Comentarios: 'Contrasena.' }, { Nombre: 'autoriza', Tipo: 'String', Comentarios: 'Autoriza [Hidden: Valor fijo 'S' para este metodo].' }];
  outputCols = [];
  outputData = [];
