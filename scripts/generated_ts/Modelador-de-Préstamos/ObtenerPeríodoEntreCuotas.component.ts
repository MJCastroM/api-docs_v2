...
@Component({
  selector: 'app-ObtenerPerodoEntreCuotas',
  templateUrl: './DocTemplate.component.html',
  styleUrls: ['./DocTemplate.component.scss'],
  animations: [ fadeInOut ],
  host: { '[@fadeInOut]': '' }
})
export class ObtenerPeriodoEntreCuotasComponent {
  pageTitle = 'Obtener Periodo Entre Cuotas';
  description = `Metodo para obtener los periodos entre cuotas parametrizados de un producto de prestamo.`;
  ...
  outputData = [{ Nombre: 'minimo', Tipo: 'Long', Comentarios: 'Valor minimo de periodo de cuotas.' }, { Nombre: 'maximo', Tipo: 'Long', Comentarios: 'Valor maximo de periodo de cuotas.' }, { Nombre: 'valorPorDefecto', Tipo: 'Long', Comentarios: 'Valor por defecto de periodo de cuotas.' }, { Nombre: 'tipo', Tipo: 'Long', Comentarios: 'Tipo de cuotas.' }, { Nombre: 'sdtListaValores', Tipo: '[sBTValor](#sbtvalor)', Comentarios: 'Listado de valores posibles.' }];
  ...
  structuredTypes = [{ typeName: 'sBTValor', fields: [{ Nombre: 'valor', Tipo: 'Long', Comentarios: 'Valor de periodo de cuotas.' }] }];
}
