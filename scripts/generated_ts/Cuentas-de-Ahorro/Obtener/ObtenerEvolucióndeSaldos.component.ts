...
@Component({
  selector: 'app-ObtenerEvolucindeSaldos',
...
export class ObtenerEvoluciondeSaldosComponent {
  ...
  description = `Metodo para obtener la evolucion del saldo de un producto de cuenta de ahorro.`;
  ...
  outputData = [{ Nombre: 'sdtEvolucionSaldo', Tipo: '[sBTEvolucionSaldos](#sbtevolucionsaldos)', Comentarios: 'Datos de la evolucion de saldos.' }];
  errorCols  = ['30001', '30002', '30003'];
  errors     = [{ Codigo: '30001', Descripcion: 'No se recibio el identificador unico de operacion.' }, { Codigo: '30002', Descripcion: 'No se recupero Operacion para el identificador: [Numero de identificador].' }, { Codigo: '30003', Descripcion: 'La operacion ingresada no corresponde a una cuenta de ahorro.' }];
