...
export class ContratarProductoconAltadeFacultadesComponent {
  ...
  description = `Metodo para contratar un producto de cuenta corriente dando de alta las facultades.`;
