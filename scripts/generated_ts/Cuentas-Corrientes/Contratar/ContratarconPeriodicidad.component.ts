...
export class ContratarconPeriodicidadComponent {
  ...
  description = `Metodo para contratar un producto de cuenta corriente ingresando un periodo de acreditacion.`;
