...
export class ObtenerDatosComponent {
  ...
  description = `Metodo para obtener los datos de un producto de cuenta corriente.`;
  ...
  errors     = [{ Codigo: '30001', Descripcion: 'No se recibio el identificador de operacion.' }, { Codigo: '30002', Descripcion: 'No se recupero la operacion para el identificador: [Numero de identificador].' }, { Codigo: '30003', Descripcion: 'La operacion ingresada no corresponde a una cuenta Corriente.' }];
