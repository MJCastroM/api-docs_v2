...
export class ObtenerChequeraComponent1751987196892 {
  ...
  errors     = [{ Código: '30001', Descripción: 'No se recibió identificador de chequera' }, { Código: '30002', Descripción: 'No existe chequera con el identificador ingresado' }];
