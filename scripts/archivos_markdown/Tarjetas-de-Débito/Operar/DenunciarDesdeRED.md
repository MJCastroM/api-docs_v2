...
::: note Método para denunciar una tarjeta de débito y darla de baja sin notificar a la RED.

**Nombre publicación:** BTTarjetasDeDebito.DenunciarDesdeRED
...
novedad | String | [Hidden: Valor fijo 'DLTRE' para este método].
