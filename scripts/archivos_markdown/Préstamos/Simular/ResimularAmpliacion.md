...
::: note Método para resimular la ampliación de un préstamo.

**Nombre publicación:** BTPrestamos.ResimularAmpliacion
...
30004 | El identificador de Ampliación no es válido.
30005 | El préstamo no pertenece al cliente.
30006 | No se recuperó la operacionUId de la operación a ampliar.
