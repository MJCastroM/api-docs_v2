...
::: note Método para obtener un listado de las monedas ingresadas en Bantotal.

**Nombre publicación:** BTConfiguracionBantotal.ObtenerMonedas
...
:--------- | :--------- | :---------
sdtMonedas | [sBTMoneda](#sbtmoneda) | Listado de monedas.
