...
::: note Método para actualizar un documento digital para un depósito a plazo.

**Nombre publicación:** BTDepositosAPlazo.ActualizarDocumentoDigital
...
30004 | La operación ingresada no corresponde a un depósito a plazo.
