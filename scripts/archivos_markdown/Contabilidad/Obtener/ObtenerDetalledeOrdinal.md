---
title: Obtener Detalle de Ordinal
breadcrumb: false
pageInfo: false
toc: false
contributors: false
...
::: note Método para obtener el detalle de un determinado ordinal de un movimiento.

**Nombre publicación:** BTContabilidad.ObtenerDetalleOrdinal
