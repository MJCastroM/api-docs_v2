...
::: note Método para obtener los préstamos de un cliente.

**Nombre publicación:** BTClientes.ObtenerPrestamos
...
cancelado | String | [Hidden: Valor fijo '' para este método].
