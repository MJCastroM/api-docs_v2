...
export class ObtenerProductosHabilitadosComponent1750258525101 {
  ...
  pubName          = 'Obtener Productos Habilitados';
  programa         = '';
  scope            = '';
