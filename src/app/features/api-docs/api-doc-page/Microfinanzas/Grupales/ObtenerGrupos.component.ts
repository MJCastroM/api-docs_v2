...
export class ObtenerGruposComponent1751987197775 {
  ...
  errors     = [{ Código: '30001', Descripción: 'No se recibió el tipo de grupo.' }, { Código: '30002', Descripción: 'No existen grupos para el tipo de grupo ingresado.' }];
