...
export class ObtenerCuentasClienteComponent1751987198671 {
  ...
  errors     = [{ Código: '30001', Descripción: 'No se recibió el identificador de persona.' }, { Código: '30002', Descripción: 'No se pudo obtener identificador único de la cuenta.' }, { Código: '30015', Descripción: 'No se recibió identificador de cuenta a consultar.' }, { Código: '30023', Descripción: 'No existe registro para el identificador único.' }];
...
\'{
  ...
  structuredTypes = [{ typeName: 'sBTCuentaCliente', fields: [{ Nombre: 'clienteUId', Tipo: 'Long', Comentarios: 'Identificador único de cuenta.' }, { Nombre: 'representativo', Tipo: 'String', Comentarios: 'Indica si es titular representativo (S/N).' }, { Nombre: 'titularidad', Tipo: '[sBTTipoIntegrante](#sbttipointegrante)', Comentarios: 'Datos de tipo de integrante.' }] }, { typeName: 'sBTTipoIntegrante', fields: [{ Nombre: 'descripcion', Tipo: 'String', Comentarios: 'Descripción del integrante.' }, { Nombre: 'identificador', Tipo: 'Int', Comentarios: 'Identificador del integrante.' }] }];
}
