...
export class ObtenerProfesionComponent1750258525393 {
  ...
  outputData = [{ Nombre: 'sdtProfesion', Tipo: '[sBTProfesion](#sbtprofesion)', Comentarios: 'Datos de la profesión.' }, { Nombre: 'fechaInicioProfesion', Tipo: 'Date', Comentarios: 'Fecha de inicio de la profesión.' }];
  errors     = [];
