...
@Component({
  selector: 'app-EliminarIntegrantedePersonaJuridica',
  templateUrl: '../../DocTemplate.component.html',
  styleUrls: ['../../DocTemplate.component.scss'],
  animations: [ fadeInOut ],
  host: { '[@fadeInOut]': '' }
})
export class EliminarIntegrantedePersonaJuridicaComponent1750272791561 {
  ...
  inputData  = [{ Nombre: 'personaJuridicaUId', Tipo: 'Long', Comentarios: 'Identificador único de persona jurídica.' }, { Nombre: 'personaIntegranteUId', Tipo: 'Long', Comentarios: 'Identificador único de persona física.' }];
  outputData = [];
  errors     = [];
