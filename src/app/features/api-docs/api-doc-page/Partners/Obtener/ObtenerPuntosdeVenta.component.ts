...
export class ObtenerPuntosdeVentaComponent1750713394207 {
    ...
    json: `
{
  ...
  structuredTypes = [{ typeName: 'sBTPartnerInReq', fields: [{ Nombre: 'partnerUId', Tipo: 'Int', Comentarios: 'Identificador del Partner.' }, { Nombre: 'puntoVentaUId', Tipo: 'Int', Comentarios: 'Identificador del punto de venta.' }, { Nombre: 'vendedorUId', Tipo: 'Int', Comentarios: 'Identificador del vendedor.' }, { Nombre: ':::', Tipo: '', Comentarios: '' }, { Nombre: '::: details sBTPuntoVenta', Tipo: '', Comentarios: '' }] }, { typeName: 'sBTPuntoVenta', fields: [{ Nombre: 'nombre', Tipo: 'String', Comentarios: 'Nombre.' }, { Nombre: 'partnerUId', Tipo: 'Int', Comentarios: 'Identificador del Partner.' }, { Nombre: 'puntoVentaUId', Tipo: 'Int', Comentarios: 'Identificador del punto de venta.' }, { Nombre: ':::', Tipo: '', Comentarios: '' }] }];
}
