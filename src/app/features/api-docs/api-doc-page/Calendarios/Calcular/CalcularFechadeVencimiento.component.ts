...
@Component({
  selector: 'app-CalcularFechadeVencimiento',
  templateUrl: '../../DocTemplate.component.html',
  styleUrls: ['../../DocTemplate.component.scss'],
  animations: [ fadeInOut ],
  host: { '[@fadeInOut]': '' }
})
export class CalcularFechadeVencimientoComponent1750258524661 {
  ...
  pubName          = 'Calcular Fecha de Vencimiento';
  programa         = '';
  scope            = '';
  ...
  inputData  = [{ Nombre: 'sucursalId', Tipo: 'Int', Comentarios: 'Identificador de sucursal.' }, { Nombre: 'fechaInicio', Tipo: 'Date', Comentarios: 'Fecha de inicio del plazo.' }, { Nombre: 'plazo', Tipo: 'Int', Comentarios: 'Plazo.' }, { Nombre: 'tipoDia', Tipo: 'Byte', Comentarios: '[Hidden: Valor fijo 1 para este método].' }, { Nombre: 'tipoVencimiento', Tipo: 'String', Comentarios: 'Tipo de ajuste al vencimiento (\'A\': Hábil anterior, \'P\': Hábil posterior, \'N\': No ajusta).' }];
