...
@Component({
  selector: 'app-CalcularPlazoenDiasHabiles',
  templateUrl: '../../DocTemplate.component.html',
  styleUrls: ['../../DocTemplate.component.scss'],
  animations: [ fadeInOut ],
  host: { '[@fadeInOut]': '' }
})
export class CalcularPlazoenDiasHabilesComponent1750272790756 {
  ...
  inputData  = [{ Nombre: 'sucursalId', Tipo: 'Int', Comentarios: 'Identificador de sucursal.' }, { Nombre: 'fechaInicio', Tipo: 'Date', Comentarios: 'Fecha de inicio del plazo.' }, { Nombre: 'fechaFin', Tipo: 'Date', Comentarios: 'Fecha de fin del plazo.' }, { Nombre: 'tipoDia', Tipo: 'Byte', Comentarios: '[Hidden: Valor fijo 6 para este método].' }, { Nombre: 'tipoVencimiento', Tipo: 'String', Comentarios: 'Tipo de ajuste al vencimiento (\'A\': Hábil anterior, \'P\': Hábil posterior, \'N\': No ajusta).' }];
