...
export class ObtenerSesionesPorUsuarioComponent1750446218604 {
  ...
  inputData  = [];
  outputData = [{ Nombre: 'sdtSesionesPorUsuario', Tipo: '[sBTSesionesPorUsuario](#sbtsesionesporusuario)', Comentarios: 'Colección de datos de sesiones por usuario.' }];
  errors     = [];
