...
export class EliminarDocumentoDigitalComponent1751987195286 {
  ...
  outputData = [];
  errors     = [{ Código: '30001', Descripción: 'No se recibió el identificador de instancia de documento digital.' }, { Código: '30002', Descripción: 'No se recibió el identificador de la operación.' }, { Código: '30003', Descripción: 'La operación ingresada no corresponde a un ahorro programado.' }, { Código: '30021', Descripción: 'No se recuperó la operación para el identificador recibido.' }, { Código: '40993', Descripción: 'Error de configuración: El vínculo de un tipo de documento digital no puede estar vacío.' }, { Código: '40994', Descripción: 'Error de configuración: El vínculo de un tipo de documento digital no puede ser distinto al de la entidad invocadora.' }];
