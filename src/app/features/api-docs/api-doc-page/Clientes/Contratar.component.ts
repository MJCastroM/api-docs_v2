...
:::`;
  backendConfig     = [{"campo":"Definir la transaccion de alta, teniendo en cuenta que","valor":""},{"campo":"2) Configurar la transaccion parametrizada mediante el mantenimiento de transacciones por servicio (HBTSBT1T).","valor":""},{"campo":"3) Se debe indicar los ordinales donde se encuentra definido el prestamo y la cuenta de cobro.","valor":""},{"campo":"4) Si la opcion de procesos por modulo 3282 se encuentra activada, el servicio considera que se permiten cobros parciales.","valor":""}];
