...
export class ObtenerDetallePosicionComponent1750713393418 {
...
\'{
  ...
  structuredTypes = [{ typeName: 'sBTDetalleClaseActivo', fields: [{ Nombre: 'datosConManejoEspecie', Tipo: '[sBTDatoConManejoEspecie](#sbtdatoconmanejoespecie)', Comentarios: 'Listado de datos con manejo de especie.' }, { Nombre: 'datosSinManejoEspecie', Tipo: '[sBTDatoSinManejoEspecie](#sbtdatosinmanejoespecie)', Comentarios: 'Listado de datos sin manejo de especie.' }, { Nombre: 'nombreElemento', Tipo: 'String', Comentarios: 'Nombre del elemento del detalle.' }, { Nombre: 'porcentajeComposicion', Tipo: 'Double', Comentarios: 'Porcentaje de composición del elemento del detalle.' }, { Nombre: 'total', Tipo: 'Double', Comentarios: 'Total del elemento del detalle.' }] }, { typeName: 'sBTDatoConManejoEspecie', fields: [{ Nombre: 'descripcion', Tipo: 'String', Comentarios: 'Descripción.' }, { Nombre: 'papelId', Tipo: 'Int', Comentarios: 'Identificador del papel.' }, { Nombre: 'resultado', Tipo: 'Double', Comentarios: 'Resultado.' }, { Nombre: 'totalEfectivo', Tipo: 'Double', Comentarios: 'Total en efectivo.' }, { Nombre: 'totalNominal', Tipo: 'Double', Comentarios: 'Total nominal.' }] }, { typeName: 'sBTDatoSinManejoEspecie', fields: [{ Nombre: 'cantidadOperaciones', Tipo: 'Int', Comentarios: 'Cantidad de operaciones.' }, { Nombre: 'monedaId', Tipo: 'Short', Comentarios: 'Identificador de la moneda.' }, { Nombre: 'signo', Tipo: 'String', Comentarios: 'Signo de la moneda.' }, { Nombre: 'total', Tipo: 'Double', Comentarios: 'Total.' }, { Nombre: 'totalOrigen', Tipo: 'Double', Comentarios: 'Total del origen.' }, { Nombre: ':::', Tipo: '', Comentarios: '' }] }];
}
